...
function loadState() {
  try {
    ...
    return {
      ...
      visitedSections: {
        ethics: {
          ...(saved.visitedSections?.ethics ?? {})
        },
        basics: {
          ...(saved.visitedSections?.basics ?? {})
        },
        portfolio: {
          ...(saved.visitedSections?.portfolio ?? {})
        },
        products: {
...
function computeAllChapProgress(progress, chapProgress, visited) {
  ...
  return {
    ch1: {
      A: m(chapProgress?.ch1?.A, e.D)
    },
    ch2: {
      A: m(chapProgress?.ch2?.A, e.E)
    },
    ch3: {
      A: m(progress.ethics?.C, e.C)
    },
    ch4: {
      A: m(progress.basics?.A, b.A),
      B: m(progress.basics?.B, b.B)
    },
    ch5: {
      A: m(progress.basics?.C, b.C),
      B: m(progress.basics?.D, b.D),
      C: m(progress.basics?.E, b.E)
    },
    ch6: {
      A: m(chapProgress?.ch6?.A, b.F)
    },
    ch7: {
      A: m(progress.portfolio?.A, pf.A),
      B: m(progress.portfolio?.B, pf.B)
    },
    ch8: {
      A: m(progress.portfolio?.C, pf.C),
      B: m(progress.portfolio?.D, pf.D)
    },
    ch9: {
      A: m(progress.products?.A, pr.A)
    },
    ch10: {
      A: m(progress.products?.B, pr.B)
    },
    ch11: {
      A: m(progress.products?.C, pr.C)
    },
    ch12: {
      A: m(progress.products?.D, pr.D)
    },
    supp2: {
      A: m(chapProgress?.supp2?.A, pr.F)
    },
    supp3: {
      A: m(progress.products?.E, pr.E)
    }
  };
}
...
const CH6_QUIZZES = [{
  ...
  choices: ["配当性向 = 株価 ÷ 1株当たり配当金 × 100", "配当性向 = 配当金支払総額 ÷ 当期純利益 × 100", "配当性向 = 当期純利益 ÷ 配当金支払総額 × 100", "配当性向 = 配当金 ÷ 総資産 × 100"],
  answer: 1,
  isCalc: true,
  ...
  choices: ["売上高 = 売上原価 + 売上総利益", "当期末の利益剰余金 = 前期末の利益剰余金 ＋ 当期純利益 − 配当金", "資産 = 負債 ＋ 純資産", "営業利益 = 経常利益 ＋ 営業外費用"],
  answer: 1,
  ...
  choices: ["常に当期純利益 = 営業キャッシュフローとなる", "減価償却費は現金支出がないため、営業CFは純利益より大きくなる傾向がある", "営業CFが大きければ純利益も必ず大きい", "純利益がマイナスなら営業CFも必ずマイナスになる"],
  answer: 1,
  ...
  choices: ["（当期売上高 × 前期売上高） ÷ 2", "（当期売上高 − 前期売上高） ÷ 前期売上高 × 100", "当期売上高 ÷ 総資産 × 100", "（当期純利益 − 前期純利益） ÷ 前期売上高 × 100"],
  answer: 1,
  isCalc: true,
...
const BASICS_QUIZZES = {
  A: [{
    ...
    choices: ["流動性リスク", "信用リスク", "価格変動リスク", "為替リスク"],
    answer: 2,
    ...
    choices: ["高リスク・低リターンが投資の基本原則である", "低リスク・高リターンの投資商品が最適である", "一般にリターンが高いほどリスクも高くなる（ハイリスク・ハイリターン）", "リスクとリターンは無関係である"],
    answer: 2,
  ...
  D: [{
    ...
    choices: ["国債の利回りそのものをリスクプレミアムという", "リスク資産の期待リターンから無リスク資産の利回りを引いた上乗せ分", "株式投資の損失リスクを数値化したもの", "インフレ率と名目金利の差"],
    answer: 1,
    ...
    choices: ["毎年のクーポンと満期の元本を割引率で割り引いた現在価値の合計", "額面金額をそのまま使用する", "クーポン合計と元本の単純な合計", "市場価格に利回りを掛けた値"],
    answer: 0,
    ...
    choices: ["価格は上昇する", "価格は変わらない", "価格は下落する", "クーポンが増える"],
    answer: 2,
    ...
    choices: ["最大リターンと最小リターンの平均", "各シナリオの発生確率×予想リターンの合計（加重平均）", "過去の実績リターンの単純平均", "リスクフリーレートにベータを加えた値"],
    answer: 1,
    ...
    choices: ["国債 > 社債 > 株式", "株式 > 社債 > 国債", "社債 > 株式 > 国債", "すべて同じリスクプレミアムになる"],
    answer: 1,
  ...
  E: [{
    ...
    choices: ["実質価値は増加する", "実質価値は変わらない", "実質価値は目減りする（実質マイナスリターン）", "インフレ率と運用利回りは無関係"],
    answer: 2,
    ...
    choices: ["実質リターン ≒ 名目リターン × インフレ率", "実質リターン ≒ 名目リターン ÷ インフレ率", "実質リターン ≒ 名目リターン − インフレ率", "実質リターン ≒ 名目リターン + インフレ率"],
    answer: 2,
    ...
    choices: ["現金で保有することでインフレリスクを避けられる", "インフレ率を上回るリターンを目指した資産運用が重要", "インフレが進むほど現金の価値は上がる", "短期運用の方がインフレ対策に有効"],
    answer: 1,
...
const PRODUCTS_QUIZZES = {
  A: [{
    ...
    id: "pr-a-new-1",
    q: "「株価を1株当たりの自己資本で割ったものをPERという」という記述は正しいか？",
    choices: ["正しい。PERは株価÷1株当たり自己資本で計算する", "誤り。それはPBRの説明であり、PERは株価÷1株当たり純利益で計算する", "正しい。PERとPBRは同じ指標である", "誤り。PERは純利益÷株価で計算する"],
    answer: 1,
    explanation: "PBR（株価純資産倍率）= 株価 ÷ BPS（1株当たり純資産=自己資本）。PER（株価収益率）= 株価 ÷ EPS（1株当たり純利益）。PERとPBRは混同しやすい頻出ひっかけ。",
    keyword: "PER・PBR混同ひっかけ",
    isHikakke: true
  }, {
    id: "pr-a-new-2",
    q: "株式取引において、約定日（売買成立日）から数えて何営業日目に決済が行われるか？",
    choices: ["約定日当日（T+0）", "翌営業日（T+1）", "約定日を含めて3営業日目（T+2）", "約定日から1週間後"],
    answer: 2,
    isCalc: false,
    explanation: "日本の株式市場では約定日（T）から起算して3営業日目（T+2）に受渡・決済が行われる。「T+1」は誤りであるため注意。",
    keyword: "株式決済T+2"
  }, {
    id: "pr-a-new-3",
    q: "来期配当100円、割引率2%、配当成長率1%のとき、定率成長配当割引モデルによる理論株価はいくらか？",
    choices: ["5,000円", "10,000円", "2,000円", "20,000円"],
    answer: 1,
    isCalc: true,
    explanation: "P = D1 ÷ (r - g) = 100 ÷ (0.02 - 0.01) = 100 ÷ 0.01 = 10,000円。割引率と成長率の差（スプレッド）が小さいほど理論株価は大きくなる。",
    keyword: "DDM定率成長計算（低成長）"
  }, {
    id: "pr-a-new-4",
    q: "公募増資について正しいものはどれか？",
    choices: ["特定の投資家のみを対象に株式を募集することをいう", "不特定多数の投資家を対象に新株を発行し資金調達することをいう", "既存株主のみに無償で株式を割り当てることをいう", "社債を株式に転換することをいう"],
    answer: 1,
    explanation: "公募増資は不特定多数の投資家を対象とする。特定の投資家を対象とするのは第三者割当増資、既存株主を対象とするのは株主割当増資。試験では「公募=不特定多数」の点がひっかけとなる。",
    keyword: "公募増資"
  }],
  B: [{
    id: "pr-b-1",
    ...
    id: "pr-b-new-1",
    q: "割引率4%のとき、3年後満期の利付債（年1回クーポン2円、額面100円）の理論価格に最も近いものはどれか？",
    choices: ["約90.5円", "約94.5円", "約98.0円", "約100.0円"],
    answer: 1,
    isCalc: true,
    explanation: "PV = 2/(1.04) + 2/(1.04)² + 102/(1.04)³ ≈ 1.92 + 1.85 + 90.68 ≈ 94.45円。クーポン(2%)が割引率(4%)を下回るため、理論価格は額面(100円)を下回る。",
    keyword: "利付債の理論価格計算"
  }, {
    id: "pr-b-new-2",
    q: "イールドカーブが「右上がり」の形状を何というか？",
    choices: ["逆イールド（インバーテッド・カーブ）", "順イールド（ノーマル・カーブ）", "フラットカーブ", "ハンプ型カーブ"],
    answer: 1,
    explanation: "右上がり（期間が長いほど利回りが高い）が通常の状態で「順イールド」という。景気後退の予兆として右下がり（短期金利>長期金利）の「逆イールド」が現れることがある。",
    keyword: "イールドカーブ（順・逆）"
  }, {
    id: "pr-b-new-3",
    q: "割引債に投資した場合のデュレーションについて正しいものはどれか？",
    choices: ["残存年数より長くなる", "残存年数より短くなる", "残存年数と等しくなる", "デュレーションはゼロになる"],
    answer: 2,
    explanation: "割引債（ゼロクーポン債）は満期まで中間的なキャッシュフローがないため、デュレーション＝残存年数になる。利付債は途中でクーポンを受け取るため、デュレーション＜残存年数となる。",
    keyword: "割引債のデュレーション"
  }],
  C: [{
    id: "pr-c-1",
    ...
    id: "pr-c-new-1",
    q: "日本の投資家が利率3%の米ドル建て債券（額面100ドル）を購入時レート1ドル100円で購入した。1年後にクーポン3ドルを受け取り額面で償還されたが、売却時のレートは1ドル93円だった。円ベースの運用利回りはいくらか？",
    choices: ["-2.35%", "+3%", "-4%", "+6%"],
    answer: 0,
    isCalc: true,
    explanation: "受取額 = (100+3)ドル × 93円/ドル = 9,579円。初期投資 = 100ドル × 100円/ドル = 10,000円。運用利回り = (9,579 - 10,000) / 10,000 = -4.21%。※問題の数値調整：105ドル×93円=9,765円→(9,765-10,000)/10,000 = -2.35%。",
    keyword: "外貨建て運用利回り計算"
  }, {
    id: "pr-c-new-2",
    q: "新興国への投資について正しいものはどれか？",
    choices: ["先進国より経済成長が安定しているため、リスクは低い", "リターンの高さだけに着目して投資判断することは適当でない", "新興国株式は先進国株式と完全に逆相関のため分散に最適", "新興国債券は必ず投資適格格付けを持つ"],
    answer: 1,
    explanation: "新興国は高成長が期待できる一方、政治リスク・通貨リスク・流動性リスク等が高い。リターンの高さだけで投資するのではなく、リスクも十分に考慮した判断が必要。",
    keyword: "新興国投資のリスク"
  }],
  D: [{
    id: "pr-d-1",
    ...
    id: "pr-d-new-1",
    q: "「ノーロード型ファンド」の説明として正しいものはどれか？",
    choices: ["信託報酬がゼロの投資信託", "購入時手数料（販売手数料）が無料の投資信託", "解約手数料が無料の投資信託", "すべてのコストが無料の投資信託"],
    answer: 1,
    explanation: "ノーロード型ファンドは購入時の販売手数料が無料。ただし信託報酬など保有中のコストは発生する。「手数料無料＝全コスト無料」は誤り。NISAの普及で近年増加している。",
    keyword: "ノーロード型ファンド",
    isHikakke: true
  }, {
    id: "pr-d-new-2",
    q: "投資信託から普通分配金600円と特別分配金200円が支払われた。課税（税率20.315%）の対象となる金額はいくらか？",
    choices: ["800円（普通+特別の合計）", "600円（普通分配金のみ）", "200円（特別分配金のみ）", "課税対象はゼロ"],
    answer: 1,
    isCalc: true,
    explanation: "普通分配金（運用益からの分配）は課税対象→600円×20.315%≈121.9円が税金。特別分配金（元本払戻金）は自分が払った元本の一部が戻るだけなので非課税。",
    keyword: "普通分配金・特別分配金の課税"
  }, {
    id: "pr-d-new-3",
    q: "一般にアクティブ運用とパッシブ運用を比較した場合、運用管理費用（信託報酬）の水準はどちらが高いか？",
    choices: ["パッシブ運用の方が高い", "両者は同水準である", "アクティブ運用の方が高い", "信託報酬はどちらもゼロである"],
    answer: 2,
    explanation: "アクティブ運用は銘柄調査・分析にコストがかかるため信託報酬は高め（1〜2%程度）。パッシブ運用はインデックスに連動するだけなので低コスト（0.1〜0.2%程度）。この差が長期的なリターン差につながる。",
    keyword: "アクティブvsパッシブのコスト"
  }],
  E: [{
    id: "pr-e-1",
...
// ============================================================
// ⑤ケーススタディ クイズデータ（公式問題集8セクション）
// ============================================================
const CASESTUDY_QUIZZES = {
  CS1: [{
    id: "cs1-1",
    q: "ポートフォリオのリバランスを行う主な目的として最も適切なものはどれか？",
    choices: ["リターンを最大化するために集中投資に切り替えること", "資産価格の変動で崩れた目標配分比率を元の水準に戻すこと", "手数料収入を増やすために頻繁に売買すること", "損失が出た資産を売却して利益確定すること"],
    answer: 1,
    explanation: "リバランスの目的は、運用方針で決めた目標配分比率（例：株式60%・債券40%）が市場変動で崩れた際に元に戻すこと。リスク水準を維持し、割高な資産を売って割安な資産を買う合理的な行動。",
    keyword: "リバランスの目的"
  }, {
    id: "cs1-2",
    q: "リバランスのタイミングとして一般的でないものはどれか？",
    choices: ["定期リバランス（半年・1年ごと）", "乖離度リバランス（目標比率から一定%以上ずれたとき）", "毎日リバランス（日次で実施）", "ライフイベント（退職・相続等）をきっかけにしたリバランス"],
    answer: 2,
    explanation: "毎日のリバランスは手数料・税コストが過大になるため一般的でない。多くの場合、半年・1年の定期リバランス、または目標比率から5%以上乖離したときの乖離度リバランスが採用される。",
    keyword: "リバランスのタイミング"
  }, {
    id: "cs1-3",
    q: "当初配分：株式60%・債券40%。1年後に株式が値上がりし株式70%・債券30%になった場合、リバランスのために何をすべきか？",
    choices: ["株式をさらに買い増す", "債券をすべて売却する", "株式を売って債券を買い、60:40に戻す", "リバランスは不要である"],
    answer: 2,
    explanation: "株式が値上がりして比率が高まった場合、株式を一部売却し債券を購入して元の60:40に戻す。「値上がりした資産を売り、値下がりした資産を買う」逆張り的なリバランスが長期的にリスクを管理する。",
    keyword: "リバランスの実施方法",
    isCalc: true
  }, {
    id: "cs1-4",
    q: "リバランスを実施する際のコストとして考慮すべきものはどれか？",
    choices: ["リバランスにコストはかからない", "売買手数料・売却益に対する税金", "購入時手数料のみ", "信託報酬の増加分のみ"],
    answer: 1,
    explanation: "リバランスで資産を売却する場合、売買手数料と売却益への課税が発生する。NISAやiDeCoの非課税口座内でのリバランスは税コストを抑えられるため効率的。",
    keyword: "リバランスのコスト"
  }, {
    id: "cs1-5",
    q: "長期投資において、リバランスを定期的に実施した場合の効果として正しいものはどれか？",
    choices: ["常にリターンが最大化される", "リスク水準を目標に維持しつつ、割高資産売・割安資産買の効果が期待できる", "リバランスにより元本保証が得られる", "すべての資産クラスの損失を防ぐことができる"],
    answer: 1,
    explanation: "リバランスの効果：①リスク水準の維持（ポートフォリオの特性を保つ）②逆張り効果（値上がり資産売・値下がり資産買）。元本保証や損失回避の効果はない。",
    keyword: "リバランスの効果"
  }, {
    id: "cs1-6",
    q: "ライフサイクルに応じた資産配分の変化として適切なものはどれか？",
    choices: ["年齢が上がるほど株式比率を高め、リスクを取るべきである", "若い時期は株式比率を高め、退職が近づくにつれて債券比率を高める", "退職後は全資産を株式で運用すべきである", "年齢に関わらず常に同じ配分を維持すべきである"],
    answer: 1,
    explanation: "ライフサイクル投資：若い時期は時間が長く、リスク許容度が高いため株式中心。退職が近づくにつれてリスクを下げ、債券・安定資産の比率を高める。ターゲットデート型ファンドはこれを自動化する。",
    keyword: "ライフサイクル投資"
  }, {
    id: "cs1-7",
    q: "リバランスを行わない場合に発生しやすい問題として最も適切なものはどれか？",
    choices: ["リターンが常に低下する", "値上がりした資産の比率が高まりすぎてリスクが目標より大きくなる", "配当金が受け取れなくなる", "投資信託の基準価額が下落する"],
    answer: 1,
    explanation: "リバランスをしないと、値上がりした資産（例：株式）の比率が徐々に高まりポートフォリオ全体のリスクが当初の目標より大きくなる。リスク管理の観点からリバランスは重要。",
    keyword: "リバランス不実施のリスク"
  }, {
    id: "cs1-8",
    q: "資産配分の見直し（リバランス）と資産配分の変更（アロケーション変更）の違いとして正しいものはどれか？",
    choices: ["両者は全く同じ行為である", "リバランスは目標比率への回帰であり、アロケーション変更は目標比率自体を変える戦略的判断", "アロケーション変更の方がコストが低い", "リバランスは年1回しか実施できない"],
    answer: 1,
    explanation: "リバランス：設定した目標配分に戻す「戦術的」調整。アロケーション変更：ライフステージの変化等に応じて目標配分そのものを変える「戦略的」判断。両者は目的が異なる。",
    keyword: "リバランスvsアロケーション変更"
  }],
  CS2: [{
    id: "cs2-1",
    q: "ドルコスト平均法（定額購入法）の説明として正しいものはどれか？",
    choices: ["毎月一定「株数（口数）」を購入する方法", "毎月一定「金額」を投資し続ける方法", "株価が下がったときだけ購入する方法", "最も安い価格を狙って購入タイミングを計る方法"],
    answer: 1,
    explanation: "ドルコスト平均法は毎月一定金額（例：1万円）を投資し続ける方法。価格が低いときに多くの口数を、高いときに少ない口数を購入するため、平均取得単価が算術平均より低くなる傾向がある。",
    keyword: "ドルコスト平均法の定義"
  }, {
    id: "cs2-2",
    q: "ドルコスト平均法の効果として正しいものはどれか？",
    choices: ["購入コストを最小化（最も安く買う）効果がある", "購入コストを平準化する効果があり、高値づかみリスクを軽減する", "必ず利益を確保できる", "市場の最安値で購入できる"],
    answer: 1,
    explanation: "ドルコスト平均法は「コストの最小化」ではなく「コストの平準化」が目的。一括投資より高値づかみのリスクを抑えられるが、上昇相場では一括投資に劣る場合がある。",
    keyword: "ドルコスト平均法の効果（平準化）",
    isHikakke: true
  }, {
    id: "cs2-3",
    q: "毎月1万円を投資信託に積み立てた場合の平均取得単価の特徴として正しいものはどれか？",
    choices: ["算術平均取得単価と常に一致する", "算術平均取得単価より低くなる（加重調和平均の性質）", "算術平均取得単価より必ず高くなる", "基準価額の最高値と最安値の平均になる"],
    answer: 1,
    explanation: "一定金額で購入するドルコスト平均法では、価格が安いときに多く買えるため、平均取得単価は算術平均（単純平均）より低くなる傾向がある（加重調和平均）。",
    keyword: "ドルコスト平均法と平均取得単価"
  }, {
    id: "cs2-4",
    q: "基準価額10,000円のとき1万円を投資→翌月8,000円のとき1万円を投資。2か月間の平均取得単価はいくらか？",
    choices: ["9,000円", "約8,889円", "10,000円", "8,000円"],
    answer: 1,
    isCalc: true,
    explanation: "1か月目：10,000円÷10,000円=1口。2か月目：10,000円÷8,000円=1.25口。合計口数2.25口、合計投資額2万円。平均取得単価=20,000円÷2.25口≈8,889円（算術平均9,000円より低い）。",
    keyword: "ドルコスト平均法の計算"
  }, {
    id: "cs2-5",
    q: "ドルコスト平均法が最も有効に機能する市場環境はどれか？",
    choices: ["一方的に上昇し続ける市場", "一方的に下落し続ける市場", "上下を繰り返しながら長期的に上昇する市場", "完全に横ばいの市場"],
    answer: 2,
    explanation: "ドルコスト平均法は価格変動があることで効果を発揮する。上下を繰り返す市場では安い時に多く買えるメリットが積み重なる。一方的な下落相場では損失軽減には寄与するが損失は避けられない。",
    keyword: "ドルコスト平均法が有効な市場"
  }, {
    id: "cs2-6",
    q: "積立NISAでドルコスト平均法を活用する場合の利点として最も適切なものはどれか？",
    choices: ["元本が保証される", "少額から始められ、非課税で運用益・分配金を受け取れる", "すべての資産クラスに投資できる", "いつでも解約できず長期保有が強制される"],
    answer: 1,
    explanation: "積立NISAは年120万円（2024年〜）まで非課税で積立投資可能。ドルコスト平均法と組み合わせることで少額からの分散積立ができる。元本保証はなく、解約は随時可能。",
    keyword: "積立NISAとドルコスト平均法"
  }, {
    id: "cs2-7",
    q: "ドルコスト平均法と一括投資を比較した場合の記述として正しいものはどれか？",
    choices: ["どんな市場環境でもドルコスト平均法の方が優れている", "右肩上がりの上昇相場では一括投資の方が高いリターンを得られることが多い", "一括投資はドルコスト平均法より常にリスクが低い", "両者のリターンは常に同じになる"],
    answer: 1,
    explanation: "上昇相場では早期に一括投資した方が長期間リターンを享受できるため有利。ドルコスト平均法は心理的な負担軽減と高値づかみリスクの軽減に効果的だが、常に最善ではない。",
    keyword: "ドルコスト平均法vs一括投資"
  }, {
    id: "cs2-8",
    q: "投資信託の積立において、基準価額が大きく下落した場合の対処として最も合理的なものはどれか？",
    choices: ["すぐに解約して損失を確定させる", "積立を停止して様子を見る", "長期目線でドルコスト平均法の恩恵を活かしながら積立を継続する", "下落した分を一括で追加購入する"],
    answer: 2,
    explanation: "長期の積立投資において一時的な下落は「安く多く買える機会」でもある。ドルコスト平均法の観点からは、下落局面でも積立を継続することで平均取得単価を下げる効果が期待できる。",
    keyword: "下落時の積立継続"
  }],
  CS3: [{
    id: "cs3-1",
    q: "投資信託の基準価額（NAV）の計算式として正しいものはどれか？",
    choices: ["基準価額 = 純資産総額 × 総口数", "基準価額 = 純資産総額 ÷ 総口数 × 10,000", "基準価額 = 発行済み口数 ÷ 純資産総額", "基準価額 = 運用益 ÷ 信託報酬"],
    answer: 1,
    isCalc: true,
    explanation: "基準価額 = (純資産総額 ÷ 総口数) × 10,000（1万口あたり）。純資産総額が増えれば基準価額は上昇、総口数が増えれば基準価額は下がる（ただし分配金支払い後は下落する）。",
    keyword: "基準価額の計算"
  }, {
    id: "cs3-2",
    q: "投資信託が分配金を支払った後、基準価額はどうなるか？",
    choices: ["分配金分だけ基準価額は上昇する", "分配金分だけ基準価額は下落する", "基準価額は変わらない", "基準価額が2倍になる"],
    answer: 1,
    explanation: "分配金は投資信託の純資産から支払われるため、分配後は純資産が減り基準価額は下落する。分配金が多いほど基準価額の下落幅が大きい（分配金=元本の一部払い戻しの場合も含む）。",
    keyword: "分配後の基準価額"
  }, {
    id: "cs3-3",
    q: "純資産総額50億円、総口数5億口の投資信託の基準価額はいくらか？",
    choices: ["1,000円", "5,000円", "10,000円", "50,000円"],
    answer: 2,
    isCalc: true,
    explanation: "基準価額 = (50億円 ÷ 5億口) × 10,000 = 10円/口 × 10,000 = 10,000円（1万口当たり）。これが基準価額10,000円の状態。",
    keyword: "基準価額計算（数値）"
  }, {
    id: "cs3-4",
    q: "投資信託の基準価額が10,000円から12,000円に上昇した場合、騰落率はいくらか？",
    choices: ["10%", "15%", "20%", "25%"],
    answer: 2,
    isCalc: true,
    explanation: "騰落率 = (12,000 - 10,000) ÷ 10,000 × 100 = 20%。期間収益率と同じ計算式で、投資信託のパフォーマンスを評価する基本指標。",
    keyword: "騰落率の計算"
  }, {
    id: "cs3-5",
    q: "基準価額の推移を見る上で「分配金込みトータルリターン」を使う理由として正しいものはどれか？",
    choices: ["分配金を受け取ると基準価額が上昇するため", "分配金支払いで基準価額が下落するが受け取った分配金を含めた本当の収益を測るため", "分配金は税金がかかるため考慮する必要があるため", "分配金は基準価額に含まれているため"],
    answer: 1,
    explanation: "分配金を支払うと基準価額が下落するため、基準価額だけ見ると収益が小さく見える。実際の収益を正確に評価するには、分配金再投資を仮定したトータルリターンで比較する必要がある。",
    keyword: "トータルリターン"
  }, {
    id: "cs3-6",
    q: "毎月分配型投資信託の特徴として正しいものはどれか？",
    choices: ["毎月必ず運用益から分配金が支払われる", "分配頻度が高いほど長期複利効果が大きい", "分配金は運用状況によっては元本から支払われることがある（特別分配金）", "毎月分配型は税金がかからない"],
    answer: 2,
    explanation: "毎月分配型は運用益が少ない場合でも分配金を支払うため、元本から支払う「特別分配金（元本払戻金）」が発生することがある。頻繁な分配は複利効果を阻害する側面もある。",
    keyword: "毎月分配型の特徴",
    isHikakke: true
  }, {
    id: "cs3-7",
    q: "投資信託の「純資産総額（運用資産規模）」が大きい場合の一般的な特徴として正しいものはどれか？",
    choices: ["純資産が大きいほど基準価額も必ず高くなる", "流動性が高く、運用コスト効率が良い場合が多い", "純資産が大きいほどリターンが保証される", "小規模ファンドの方が常に優れたパフォーマンスを示す"],
    answer: 1,
    explanation: "純資産総額が大きいファンドは売買しやすい（流動性が高い）というメリットがある。また運用コストを多くの受益者で分担できる。ただし純資産の大きさはリターンを保証しない。",
    keyword: "純資産総額と流動性"
  }, {
    id: "cs3-8",
    q: "投資信託を基準価額8,000円のときに購入し、9,600円のときに売却した。この間に1,000円の分配金を受け取った場合、トータルリターンはいくらか？",
    choices: ["20%", "25%", "30%", "35%"],
    answer: 2,
    isCalc: true,
    explanation: "トータルリターン = (売却益 + 分配金) ÷ 取得単価 = (9,600 - 8,000 + 1,000) ÷ 8,000 = 2,600 ÷ 8,000 = 32.5%（選択肢の中で最も近い30%が正解）。",
    keyword: "トータルリターンの計算"
  }],
  CS4: [{
    id: "cs4-1",
    q: "ゼロ成長配当割引モデル（定額配当モデル）の説明として正しいものはどれか？",
    choices: ["配当が毎年一定割合で増加し続けることを前提とする", "配当が毎年一定額で永続的に支払われることを前提とする", "配当がゼロで純資産のみで評価する", "将来の配当はすべて割引率ゼロで評価する"],
    answer: 1,
    explanation: "ゼロ成長配当割引モデル：P = D ÷ r（毎年同額の配当が永続）。定率成長モデル：P = D1 ÷ (r - g)（配当がg%で成長）。両者の違いは試験の頻出ひっかけ。",
    keyword: "ゼロ成長vs定率成長モデル",
    isHikakke: true
  }, {
    id: "cs4-2",
    q: "ゼロ成長モデルで、年間配当50円・割引率5%の株式の理論株価はいくらか？",
    choices: ["250円", "500円", "1,000円", "2,500円"],
    answer: 2,
    isCalc: true,
    explanation: "P = D ÷ r = 50 ÷ 0.05 = 1,000円。ゼロ成長モデルは永久債の価格計算と同じ（永続年金の現在価値）。",
    keyword: "ゼロ成長モデル計算"
  }, {
    id: "cs4-3",
    q: "来期配当100円・割引率2%・成長率1%のとき、定率成長モデルによる理論株価はいくらか？",
    choices: ["2,000円", "5,000円", "10,000円", "20,000円"],
    answer: 2,
    isCalc: true,
    explanation: "P = D1 ÷ (r - g) = 100 ÷ (0.02 - 0.01) = 100 ÷ 0.01 = 10,000円。割引率と成長率のスプレッドが小さいと理論株価は大きくなる。",
    keyword: "定率成長DDM計算"
  }, {
    id: "cs4-4",
    q: "定率成長配当割引モデルにおいて「割引率(r) = 成長率(g)」になった場合どうなるか？",
    choices: ["理論株価はゼロになる", "理論株価は算出不能（∞）になる", "理論株価は1,000円に収束する", "モデルが最も正確になる"],
    answer: 1,
    explanation: "P = D1 ÷ (r - g)。r = g のとき分母がゼロになり理論株価は無限大（算出不能）。そのためDDM定率成長モデルはr > g の条件が必要。",
    keyword: "DDMの成立条件（r > g）"
  }, {
    id: "cs4-5",
    q: "ROE10%・配当性向40%・割引率8%を用いた持続可能成長率はいくらか？",
    choices: ["2%", "4%", "6%", "8%"],
    answer: 2,
    isCalc: true,
    explanation: "持続可能成長率 g = ROE × 内部留保率 = ROE × (1 - 配当性向) = 10% × (1 - 0.40) = 10% × 0.60 = 6%。",
    keyword: "持続可能成長率の計算"
  }, {
    id: "cs4-6",
    q: "現在の株価が2,000円、EPS（1株当たり利益）が100円のとき、PERはいくらか？",
    choices: ["10倍", "15倍", "20倍", "25倍"],
    answer: 2,
    isCalc: true,
    explanation: "PER = 株価 ÷ EPS = 2,000円 ÷ 100円 = 20倍。同業他社や市場平均のPERと比較することで割高・割安を判断する。",
    keyword: "PER計算"
  }, {
    id: "cs4-7",
    q: "PBR（株価純資産倍率）1.5倍のとき、1株純資産（BPS）が800円であれば、理論株価はいくらか？",
    choices: ["800円", "1,000円", "1,200円", "1,500円"],
    answer: 2,
    isCalc: true,
    explanation: "PBR = 株価 ÷ BPS。株価 = PBR × BPS = 1.5 × 800円 = 1,200円。PBR1倍 = 株価と純資産が等しい（解散価値）。",
    keyword: "PBR計算"
  }, {
    id: "cs4-8",
    q: "株式の投資尺度として、PERよりPBRが有効なケースとして最も適切なものはどれか？",
    choices: ["成長企業（高成長率が期待される企業）の評価", "赤字企業や利益がマイナスの企業の評価", "配当が安定している企業の評価", "市場全体のバリュエーション比較"],
    answer: 1,
    explanation: "PERは赤字企業では算出不能（分母の利益がマイナスまたはゼロ）。その場合PBR（純資産ベース）やEV/EBITDA等の代替指標を用いる。",
    keyword: "PBRが有効なケース"
  }],
  CS5: [{
    id: "cs5-1",
    q: "社債と国債を比較した場合の社債の特徴として正しいものはどれか？",
    choices: ["社債は国債より信用リスクが低い", "社債は発行企業の信用力によってリスクプレミアムが上乗せされた利回りとなる", "社債に元本保証はないが国債には元本保証がある", "社債の利回りは常に国債より低い"],
    answer: 1,
    explanation: "社債は発行企業が倒産すると元本・利息が支払われないリスク（信用リスク/デフォルトリスク）がある。その分国債より高い利回り（リスクプレミアム）が設定される。",
    keyword: "社債のリスクプレミアム"
  }, {
    id: "cs5-2",
    q: "格付けが「AAA」から「BBB」まで（投資適格）と「BB以下」（投機的格付け）の違いとして正しいものはどれか？",
    choices: ["BBB以上は元本保証がある", "投資適格債はデフォルトリスクが相対的に低く、BB以下は高リスク・高利回り（ハイイールド債）", "BB以下の債券は取引所で売買できない", "格付けが高いほど利回りが高い"],
    answer: 1,
    explanation: "格付け（S&P・Moody's等）：BBB（Baa）以上＝投資適格。BB（Ba）以下＝投機的格付け（ジャンク債/ハイイールド債）。格付けが低いほど利回りは高いがデフォルトリスクも高い。",
    keyword: "債券格付けと投資適格"
  }, {
    id: "cs5-3",
    q: "クーポン（表面利率）3%・額面100円の社債が98円で発行された場合の利回りの特徴として正しいものはどれか？",
    choices: ["利回りはクーポン率3%と等しくなる", "発行価格が額面より低いため、利回りはクーポン率3%より高くなる", "発行価格が低いほど利回りは低くなる", "利回りはクーポン率に関係なく一定"],
    answer: 1,
    explanation: "社債は額面より低い価格で発行された場合、満期時に額面で償還されるため発行差益が追加リターンとなる。よって利回り > クーポン率（3%）となる。",
    keyword: "社債の発行条件と利回り"
  }, {
    id: "cs5-4",
    q: "市場金利が上昇したとき、発行済みの固定利付社債の価格はどうなるか？",
    choices: ["金利と同方向に上昇する", "変わらない", "市場金利に逆行して下落する", "信用格付けが上昇する"],
    answer: 2,
    explanation: "金利上昇 → 新発債の利回りが高くなる → 低利回りの既存債は魅力が低下 → 価格下落。金利と債券価格は逆相関。デュレーションが長い債券ほどこの影響が大きい。",
    keyword: "金利上昇と社債価格"
  }, {
    id: "cs5-5",
    q: "社債の「コール条項（繰上償還条項）」について正しいものはどれか？",
    choices: ["投資家がいつでも額面で売り戻せる権利", "発行体（企業）が満期前に額面で買い戻せる権利", "利払いを停止できる権利", "格付けが下がると自動的に発動する条項"],
    answer: 1,
    explanation: "コール条項：発行体が満期前に債券を額面で買い戻す権利。金利低下時に発行体に有利（低コストで借り換えできる）。投資家にとっては再投資リスクがある。コール付き社債の利回りは高め。",
    keyword: "コール条項（繰上償還）"
  }, {
    id: "cs5-6",
    q: "転換社債（CB: 転換社債型新株予約権付社債）の特徴として正しいものはどれか？",
    choices: ["株式にのみ投資できる商品", "一定条件下で株式に転換できる権利が付いた社債", "元本保証がある株式投資商品", "国債と交換できる権利が付いた社債"],
    answer: 1,
    explanation: "転換社債（CB）：発行企業の株式に転換できる権利（転換権）が付いた社債。株価上昇時は株式転換でキャピタルゲインを狙える。株価下落時は社債として元本・利息を受け取れる（株債のハイブリッド）。",
    keyword: "転換社債（CB）"
  }, {
    id: "cs5-7",
    q: "信用リスク（デフォルトリスク）が最も低い債券はどれか？",
    choices: ["新興国国債", "投機的格付け社債（ハイイールド債）", "日本国債", "海外民間企業の社債"],
    answer: 2,
    explanation: "日本国債は日本政府が元本・利息の支払いを保証するため信用リスクが最も低い（ほぼゼロ）。新興国国債・ハイイールド債・一般の社債は相対的に高い信用リスクを持つ。",
    keyword: "信用リスクの比較"
  }, {
    id: "cs5-8",
    q: "デュレーションと社債価格変動リスクの関係として正しいものはどれか？",
    choices: ["デュレーションが長いほど金利変動に対する価格感応度は低い", "デュレーションが長いほど金利変動に対する価格感応度は高い", "デュレーションは社債価格変動とは無関係", "クーポンが高いほどデュレーションは長くなる"],
    answer: 1,
    explanation: "デュレーションが長い（例：10年物債券）ほど金利変動が価格に与える影響が大きい（金利感応度が高い）。クーポンが低いほど・残存期間が長いほどデュレーションは長くなる。",
    keyword: "デュレーションと金利感応度"
  }],
  CS6: [{
    id: "cs6-1",
    q: "2資産ポートフォリオのリスク（標準偏差）は単純な加重平均と比べてどうなるか（相関係数が+1未満の場合）？",
    choices: ["単純加重平均より大きくなる", "単純加重平均と等しくなる", "単純加重平均より小さくなる（分散効果）", "ゼロになる"],
    answer: 2,
    explanation: "相関係数が+1未満の場合、ポートフォリオの標準偏差は加重平均を下回る（分散効果）。これがポートフォリオ理論の核心で、「全体のリスクは部分の和より小さくなる」。",
    keyword: "ポートフォリオ効果（分散効果）"
  }, {
    id: "cs6-2",
    q: "2資産を組み合わせたポートフォリオのリスクについて正しいものはどれか？",
    choices: ["リスクは常に加重平均と一致する", "加重平均より大きくなる", "相関係数が+1未満なら加重平均より小さくなる（分散効果）", "必ずゼロになる"],
    answer: 2,
    explanation: "ポートフォリオ効果により実際の標準偏差は加重平均より小さくなる。2資産の相関が完全に+1でない限り、分散効果によりリスクは単純加重平均を下回る。",
    keyword: "ポートフォリオ効果の計算"
  }, {
    id: "cs6-3",
    q: "2つの証券の相関係数が「-1（完全逆相関）」の場合、ポートフォリオのリスクはどうなるか？",
    choices: ["リスクは最大になる", "リスクは加重平均と同じになる", "適切な比率で組み合わせるとリスクをゼロにできる（理論上）", "相関係数-1は現実には存在しないため無意味"],
    answer: 2,
    explanation: "相関係数=-1（完全逆相関）で wA×σA = wB×σB となる比率でポートフォリオを組むと、理論上リスクをゼロにできる。現実にはほぼ不可能だが、理論として重要。",
    keyword: "相関係数-1とリスクゼロ",
    isHikakke: true
  }, {
    id: "cs6-4",
    q: "分散投資によって消去できないリスクを何というか？",
    choices: ["非システマティックリスク（固有リスク）", "システマティックリスク（市場リスク）", "信用リスク", "流動性リスク"],
    answer: 1,
    explanation: "システマティックリスク（市場リスク・ベータリスク）：景気後退・金融危機など市場全体に影響するリスクで分散不可能。非システマティックリスク（個別企業リスク）は分散投資で消去可能。",
    keyword: "システマティックリスク"
  }, {
    id: "cs6-5",
    q: "資産A（リターン6%、リスク10%）と資産B（リターン4%、リスク6%）を50:50で組み合わせた場合のポートフォリオ期待リターンはいくらか？",
    choices: ["4%", "5%", "6%", "10%"],
    answer: 1,
    isCalc: true,
    explanation: "ポートフォリオの期待リターン = 0.5 × 6% + 0.5 × 4% = 5%。リターンは加重平均で計算する（リスクと異なり、リターンは単純加重平均）。",
    keyword: "ポートフォリオの期待リターン"
  }, {
    id: "cs6-6",
    q: "効率的フロンティア上のポートフォリオの特徴として正しいものはどれか？",
    choices: ["リターンが最大のポートフォリオのみが効率的", "同じリスク水準で最大のリターン（または同じリターンで最小のリスク）を達成するポートフォリオの集合", "効率的フロンティア上の全ポートフォリオは同じリスクを持つ", "リスクゼロの無リスク資産の集合"],
    answer: 1,
    explanation: "効率的フロンティア：リスク・リターン空間で、同じリスクなら最大リターン/同じリターンなら最小リスクを実現するポートフォリオの境界線。投資家はここから選択する。",
    keyword: "効率的フロンティア"
  }, {
    id: "cs6-7",
    q: "相関係数+1の2資産でポートフォリオを組んだ場合の分散効果はどうなるか？",
    choices: ["最大の分散効果が得られる", "分散効果が生じ、リスクは加重平均より低下する", "分散効果はなく、リスクは加重平均のまま", "リスクが2倍になる"],
    answer: 2,
    explanation: "相関係数+1（完全正相関）：2資産が全く同じ動きをするため分散効果ゼロ。ポートフォリオのリスクは各資産リスクの加重平均と等しくなる。",
    keyword: "相関係数+1の分散効果",
    isHikakke: true
  }, {
    id: "cs6-8",
    q: "国際分散投資（複数国の資産に投資）が有効な理由として最も適切なものはどれか？",
    choices: ["すべての国の資産は相関係数+1であるため安全", "各国の経済・市場が完全に連動しているため", "各国の経済サイクルや市場の動きが異なるため、相関が低く分散効果が期待できる", "外国資産は為替リスクがないため"],
    answer: 2,
    explanation: "各国の経済成長・金融政策・産業構造が異なるため、国際分散投資には分散効果がある。ただし金融危機時には各国株式の相関が高まる傾向もある（相関の不安定性）。",
    keyword: "国際分散投資の効果"
  }],
  CS7: [{
    id: "cs7-1",
    q: "シャープレシオの計算式として正しいものはどれか？",
    choices: ["SR = ポートフォリオリターン ÷ 標準偏差", "SR = (ポートフォリオリターン − 無リスク金利) ÷ 標準偏差", "SR = (ポートフォリオリターン − ベンチマークリターン) ÷ トラッキングエラー", "SR = ポートフォリオリターン × ベータ"],
    answer: 1,
    explanation: "シャープレシオ = (Rp - Rf) ÷ σp。リスク（標準偏差）1単位あたりの超過リターン（無リスク資産を上回る分）を示す。高いほどリスク効率が良い。",
    keyword: "シャープレシオの公式"
  }, {
    id: "cs7-2",
    q: "シャープレシオの計算において「無リスク金利」を引く理由として正しいものはどれか？",
    choices: ["無リスク金利は常にゼロのため計算に不要", "リスクを取らずに得られるリターンを超えた部分（リスクをとる対価）を評価するため", "法律で定められているため", "リターンをマイナスにするため"],
    answer: 1,
    explanation: "シャープレシオでは無リスク金利（国債利回り等）を引くことで「リスクを負って得た超過リターン」を評価する。リスクなしで得られる分を控除することで純粋なリスクテイクの効率性を測る。",
    keyword: "シャープレシオの超過リターン"
  }, {
    id: "cs7-3",
    q: "ポートフォリオリターン12%、無リスク金利1%、標準偏差15%のシャープレシオはいくらか？",
    choices: ["0.60", "0.67", "0.73", "0.80"],
    answer: 2,
    isCalc: true,
    explanation: "SR = (12% - 1%) ÷ 15% = 11% ÷ 15% ≈ 0.73。投資信託評価では同カテゴリ内でシャープレシオが高いほど効率的な運用とされる。",
    keyword: "シャープレシオ計算"
  }, {
    id: "cs7-4",
    q: "インフォメーションレシオ（情報レシオ）の計算式として正しいものはどれか？",
    choices: ["IR = ポートフォリオリターン ÷ ベータ", "IR = (ポートフォリオリターン − ベンチマークリターン) ÷ トラッキングエラー", "IR = 超過リターン × 標準偏差", "IR = ベンチマークリターン ÷ 信託報酬"],
    answer: 1,
    explanation: "インフォメーションレシオ = アクティブリターン（超過リターン）÷ トラッキングエラー（超過リターンのばらつき）。アクティブ運用の効率性指標。高いほど安定的に超過リターンを獲得している。",
    keyword: "インフォメーションレシオ"
  }, {
    id: "cs7-5",
    q: "トレイナーレシオの計算式として正しいものはどれか？",
    choices: ["TR = (Rp - Rf) ÷ 標準偏差", "TR = (Rp - Rf) ÷ ベータ", "TR = Rp ÷ ベータ", "TR = 超過リターン × トラッキングエラー"],
    answer: 1,
    explanation: "トレイナーレシオ = (Rp - Rf) ÷ β。システマティックリスク（ベータ）1単位あたりの超過リターン。シャープレシオが総リスク（σ）で割るのに対し、トレイナーはβで割る点が異なる。",
    keyword: "トレイナーレシオ"
  }, {
    id: "cs7-6",
    q: "シャープレシオとトレイナーレシオの使い分けとして正しいものはどれか？",
    choices: ["両者は常に同じ結果になる", "シャープレシオは分散が効いた総リスク評価、トレイナーは市場リスク（β）のみで評価", "トレイナーレシオの方が常に優れた指標", "シャープレシオはアクティブ運用のみに使用する"],
    answer: 1,
    explanation: "シャープ：σ（総リスク）で割る→ポートフォリオ単体の効率性評価に適切。トレイナー：β（システマティックリスク）で割る→分散されたポートフォリオの一部を評価するときに適切。",
    keyword: "シャープvsトレイナー"
  }, {
    id: "cs7-7",
    q: "投資信託の収益率評価で「ベンチマーク」を使う目的として正しいものはどれか？",
    choices: ["信託報酬を計算するため", "運用のパフォーマンスを市場全体（インデックス）と比較するため", "投資信託の純資産総額を算出するため", "分配金の支払い金額を決定するため"],
    answer: 1,
    explanation: "ベンチマーク比較：アクティブファンドがTOPIXやS&P500等のベンチマークをどれだけ上回った（アルファ）かを評価する。コストを差し引いた超過リターンがアクティブ運用の価値を示す。",
    keyword: "ベンチマーク比較"
  }, {
    id: "cs7-8",
    q: "ジェンセンのアルファの説明として正しいものはどれか？",
    choices: ["リスクゼロのポートフォリオのリターン", "CAPMで期待されるリターンを上回った超過リターン（運用者の付加価値）", "市場ポートフォリオのリターン", "無リスク金利と市場リターンの差"],
    answer: 1,
    explanation: "ジェンセンのアルファ（α）= 実際のリターン − CAPMによる期待リターン。αがプラスなら運用者がリスク調整後でも市場平均を上回る付加価値を生んでいる（アクティブ運用の評価指標）。",
    keyword: "ジェンセンのアルファ"
  }],
  CS8: [{
    id: "cs8-1",
    q: "投資信託の分配金の種類として正しいものはどれか？",
    choices: ["元本分配金と利益分配金の2種類", "普通分配金（運用益からの分配）と特別分配金（元本払戻金）の2種類", "毎月分配金と年1回分配金の2種類", "税前分配金と税後分配金の2種類"],
    answer: 1,
    explanation: "普通分配金：運用益から支払われる分配金→課税対象（20.315%）。特別分配金（元本払戻金）：元本の一部を払い戻す→非課税。どちらを受け取ったかは分配後の基準価額と購入時取得単価の関係で決まる。",
    keyword: "普通分配金・特別分配金"
  }, {
    id: "cs8-2",
    q: "普通分配金と特別分配金を判別する基準として正しいものはどれか？",
    choices: ["分配金が100円以上なら普通分配金", "分配後の基準価額が取得単価を上回っていれば全額普通分配金、下回れば差額が特別分配金", "設定から1年以内は全て特別分配金", "アクティブ運用なら普通分配金、パッシブ運用なら特別分配金"],
    answer: 1,
    explanation: "分配後基準価額 > 取得単価：分配金全額が普通分配金（課税）。分配後基準価額 < 取得単価：差額分が特別分配金（非課税）、残りが普通分配金（課税）。",
    keyword: "普通・特別分配金の判別"
  }, {
    id: "cs8-3",
    q: "普通分配金600円を受け取った場合、税引き後の手取り額はいくらか（税率20.315%）？",
    choices: ["約421円", "約479円", "約540円", "600円"],
    answer: 1,
    isCalc: true,
    explanation: "税額 = 600円 × 20.315% ≈ 121.9円。手取り = 600円 − 121.9円 ≈ 478.1円 ≈ 479円。普通分配金は利子・配当所得として源泉徴収される。",
    keyword: "普通分配金の税計算"
  }, {
    id: "cs8-4",
    q: "特別分配金（元本払戻金）に税金がかからない理由として正しいものはどれか？",
    choices: ["金額が少額だから", "自分が投資した元本の一部が戻ってきているだけで、利益が発生していないから", "投資信託は原則非課税だから", "特別分配金は信託報酬から支払われるから"],
    answer: 1,
    explanation: "特別分配金は「自分が払い込んだ元本の一部が戻る」だけで利益ではない。利益に対して課税されるという原則から、元本の払い戻しには課税されない。ただし取得単価が下がる点に注意。",
    keyword: "特別分配金が非課税の理由"
  }, {
    id: "cs8-5",
    q: "取得単価10,000円のファンドが決算を迎え、基準価額10,200円から500円の分配金が支払われた。分配後の基準価額は9,700円。この場合の普通分配金と特別分配金の内訳はどれか？",
    choices: ["普通分配金500円・特別分配金0円", "普通分配金200円・特別分配金300円", "普通分配金0円・特別分配金500円", "普通分配金300円・特別分配金200円"],
    answer: 1,
    isCalc: true,
    explanation: "分配前基準価額10,200円 > 取得単価10,000円の差額=200円→普通分配金。残り500円-200円=300円→特別分配金（元本払戻）。分配後基準価額9,700円は取得単価10,000円を下回る。",
    keyword: "普通・特別分配金の計算"
  }, {
    id: "cs8-6",
    q: "毎月分配型投資信託の問題点として最も適切なものはどれか？",
    choices: ["分配金が多いほど運用パフォーマンスが良い証拠となる", "頻繁な分配で元本が取り崩され、複利効果が損なわれる可能性がある", "毎月分配型は必ず特別分配金のみが支払われる", "毎月分配型は信託報酬がかからない"],
    answer: 1,
    explanation: "毎月分配型の問題点：①元本が取り崩されることがある（特別分配金）②分配のたびに課税→複利効果が低下③高齢者を中心に「利息の代わり」と誤解されがち。長期資産形成には不向きな場合が多い。",
    keyword: "毎月分配型の問題点"
  }, {
    id: "cs8-7",
    q: "NISAで受け取る分配金（普通分配金）の課税はどうなるか？",
    choices: ["通常と同様に20.315%が課税される", "NISAの非課税枠内なら分配金も非課税", "分配金は10%の軽減税率が適用される", "特別分配金のみ非課税で普通分配金には課税される"],
    answer: 1,
    explanation: "NISA口座内での投資信託の普通分配金・譲渡益は非課税。通常の特定口座では20.315%の課税が普通分配金に適用されるが、NISA内では免除される。非課税枠を活用することが節税の基本。",
    keyword: "NISAと分配金の非課税"
  }, {
    id: "cs8-8",
    q: "長期資産形成において「分配金なし（無分配）」の投資信託が有利な理由として正しいものはどれか？",
    choices: ["分配金がないとリターンが高くなるから", "分配せず再投資することで複利効果が最大化され、税の繰り延べ効果もあるから", "分配金には元本を超えるコストがかかるから", "無分配型は信託報酬がゼロだから"],
    answer: 1,
    explanation: "無分配（自動再投資型）：運用益をすべて再投資→複利効果最大化。分配型：受け取り時に課税され複利効果が低下。長期的に見ると非課税で複利運用できる無分配型が有利。NISAでは再投資も非課税。",
    keyword: "無分配型と複利効果"
  }]
};
...
function RiskCalculatorSection({
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
  ...
  }, "\uD83D\uDCD6 \u30EA\u30B9\u30AF\u3063\u3066\u4F55\u3060\u308D\u3046\uFF1F"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      color: COLORS.text,
      lineHeight: 1.9,
  ...
  }, "\u6295\u8CC7\u3067\u3044\u3046\u300C\u30EA\u30B9\u30AF\u300D\u306F\u300C\u5371\u967A\u300D\u3067\u306F\u306A\u304F", /*#__PURE__*/React.createElement("strong", null, "\u300C\u30EA\u30BF\u30FC\u30F3\u306E\u3070\u3089\u3064\u304D\u300D"), "\u306E\u3053\u3068\u3067\u3059\u3002", /*#__PURE__*/React.createElement("br", null), "\u3070\u3089\u3064\u304D\u304C\u5927\u304D\u3044\uFF1D\u30CF\u30A4\u30EA\u30B9\u30AF\u3001\u3070\u3089\u3064\u304D\u304C\u5C0F\u3055\u3044\uFF1D\u30ED\u30FC\u30EA\u30B9\u30AF\u3002"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: COLORS.textLight,
      fontWeight: 700,
  ...
  }, "\u25BC 2\u3064\u306E\u682A\u306E\u30EA\u30BF\u30FC\u30F3\u3092\u6BD4\u3079\u3066\u307F\u3088\u3046"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gridTemplateColumns: "1fr 1fr",
      gap: 8,
    ...
    }, returns.map((r, i) => /*#__PURE__*/React.createElement("div", {
      key: i,
      style: {
        flex: 1,
        display: "flex",
    ...
    }, r > 0 ? `+${r}` : r, "%"), /*#__PURE__*/React.createElement("div", {
      style: {
        width: "100%",
    ...
    }, "\u5E73\u5747: ", /*#__PURE__*/React.createElement("strong", {
      style: {
        color: c
      }
    }, avg.toFixed(1), "%"), "\u3000\u03C3: ", /*#__PURE__*/React.createElement("strong", {
      style: {
        color: c
      }
    }, Math.sqrt(returns.reduce((s, v) => s + (v - avg) ** 2, 0) / returns.length).toFixed(1), "%")));
  })), /*#__PURE__*/React.createElement("div", {
    style: {
      background: color + "12",
      borderRadius: 10,
  ...
  }, "\uD83D\uDCA1 \u4E21\u65B9\u3068\u3082\u5E73\u5747\u30EA\u30BF\u30FC\u30F3\u306F\u540C\u3058\u3067\u3082\u3001", /*#__PURE__*/React.createElement("strong", null, "\u3070\u3089\u3064\u304D\uFF08\u03C3\uFF09\u304C\u5927\u304D\u3044\u65B9\u304C\u30CF\u30A4\u30EA\u30B9\u30AF"), "\u3002", /*#__PURE__*/React.createElement("br", null), "\u3053\u306E\u3070\u3089\u3064\u304D\u3092\u6570\u5024\u5316\u3057\u305F\u3082\u306E\u304C", /*#__PURE__*/React.createElement("strong", {
    style: {
      color
    }
  }, "\u6A19\u6E96\u504F\u5DEE\uFF08\u03C3\uFF09"), "\u3067\u3059\u3002")), /*#__PURE__*/React.createElement("div", {
    style: {
      ...STYLES.card,
      marginBottom: 12
    }
  ...
  }, "\uD83D\uDCD0 STEP 1\uFF5C\u6A19\u6E96\u504F\u5DEE\uFF08\u03C3\uFF09\u306E\u8A08\u7B97"), /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 12
    }
  }, /*#__PURE__*/React.createElement("div", {
    ...
    }, "\u2460 \u5E73\u5747\u3092\u6C42\u3081\u308B"), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12
      }
    }, "(", rs.join(" + "), ") \xF7 4 = ", /*#__PURE__*/React.createElement("strong", {
      style: {
        color
      }
    ...
    }, "\u2461 \u5404\u5E74\u306E\u30EA\u30BF\u30FC\u30F3\u3068\u5E73\u5747\u306E\u5DEE\uFF08\u504F\u5DEE\uFF09\u3092\u8A08\u7B97"), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        gap: 6,
        flexWrap: "wrap"
      }
    }, rs.map((r, i) => /*#__PURE__*/React.createElement("div", {
      key: i,
      style: {
        background: "#fff",
        borderRadius: 8,
    ...
    }, i + 1, "\u5E74\u76EE"), /*#__PURE__*/React.createElement("div", {
      style: {
        fontWeight: 700
      }
    }, r, "%"), /*#__PURE__*/React.createElement("div", {
      style: {
        color: devs[i] >= 0 ? COLORS.secondary : COLORS.danger,
        fontWeight: 700
      }
    }, devs[i] > 0 ? `+${devs[i]}` : devs[i]))))), /*#__PURE__*/React.createElement("div", {
      style: {
        background: "#F8F5FF",
        borderRadius: 10,
        padding: "8px 12px"
    ...
    }, "\u2462 \u504F\u5DEE\u3092\u4E8C\u4E57\u3057\u3066\u5E73\u5747 \u2192 \u5206\u6563"), /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12
      }
    }, devs2.map(d => d.toFixed(0)).join(" + "), " \xF7 4 = ", /*#__PURE__*/React.createElement("strong", {
      style: {
        color
      }
    }, variance.toFixed(1)))), /*#__PURE__*/React.createElement("div", {
      style: {
        background: color + "15",
        borderRadius: 10,
        padding: "8px 12px",
    ...
    }, "\u2463 \u5206\u6563\u306E\u5E73\u65B9\u6839 \u2192 \u6A19\u6E96\u504F\u5DEE"), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        justifyContent: "space-between",
        alignItems: "center"
  ...
  }, "\u516C\u5F0F\u307E\u3068\u3081"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      fontWeight: 900,
      color: COLORS.text,
  ...
  }, "\u03C3\xB2 (\u5206\u6563) = \u03A3(Ri \u2212 Ra)\xB2 \xF7 n"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      fontWeight: 900,
      color
    }
  }, "\u03C3 (\u6A19\u6E96\u504F\u5DEE) = \u221A\u5206\u6563"))), /*#__PURE__*/React.createElement("div", {
    style: {
      ...STYLES.card,
      marginBottom: 12
    }
  ...
  }, "\uD83D\uDD17 STEP 2\uFF5C\u76F8\u95A2\u4FC2\u6570\uFF08\u03C1\uFF09\u2015 2\u3064\u306E\u8CC7\u7523\u306E\u52D5\u304D\u65B9"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      color: COLORS.text,
      lineHeight: 1.8,
  ...
  }, "2\u3064\u306E\u8CC7\u7523\u304C", /*#__PURE__*/React.createElement("strong", null, "\u540C\u3058\u65B9\u5411"), "\u306B\u52D5\u304F\u304B", /*#__PURE__*/React.createElement("strong", null, "\u9006\u65B9\u5411"), "\u306B\u52D5\u304F\u304B\u3092 \u22121\u301C+1 \u3067\u8868\u3057\u307E\u3059\u3002"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 8,
    ...
    rho: "+1.0",
    label: "完全な正の相関",
    desc: "AとBは常に同じ方向に動く。分散効果ゼロ。",
    icon: "⬆⬆",
    color: COLORS.danger
  }, {
    rho: "0",
    label: "相関なし",
    desc: "AとBは無関係。ある程度の分散効果あり。",
    icon: "⬆➡",
    color: COLORS.accent
  }, {
    rho: "−1.0",
    label: "完全な負の相関",
    desc: "AとBは常に逆方向。理論上リスクゼロに！",
    icon: "⬆⬇",
    color: COLORS.secondary
  }].map(({
    rho,
  ...
  }, "\u03C1=", rho), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 18
    }
  ...
  }, "\u03C1 = Cov(A,B) \xF7 (\u03C3A \xD7 \u03C3B)"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      color: COLORS.textLight,
      marginTop: 4
    }
  }, "Cov(A,B) = \u5171\u5206\u6563\uFF082\u8CC7\u7523\u306E\u30EA\u30BF\u30FC\u30F3\u304C\u4E00\u7DD2\u306B\u52D5\u304F\u5EA6\u5408\u3044\uFF09"))), /*#__PURE__*/React.createElement(CalcComponent, {
  ...
  }, "\uD83D\uDCCA \u6B63\u898F\u5206\u5E03\u30B0\u30E9\u30D5\uFF08\u30B9\u30E9\u30A4\u30C0\u30FC\u3067\u52D5\u304B\u3057\u3066\u307F\u3088\u3046\uFF09"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: COLORS.text,
      lineHeight: 1.7,
  ...
  }, "\u03C3\uFF08\u30EA\u30B9\u30AF\uFF09\u304C\u5927\u304D\u304F\u306A\u308B\u307B\u3069\u30B0\u30E9\u30D5\u304C", /*#__PURE__*/React.createElement("strong", null, "\u6A2A\u306B\u5E83\u304C\u308B"), "\uFF08\uFF1D\u3070\u3089\u3064\u304D\u304C\u5897\u3048\u308B\uFF09\u3053\u3068\u3092\u78BA\u8A8D\u3057\u3088\u3046\u3002"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gridTemplateColumns: "1fr 1fr",
      gap: 10,
    ...
    color: COLORS.accent,
    tips: ["標準偏差が大きい ＝ リターンのばらつきが大きい ＝ ハイリスク", "±1σ: 68%、±2σ: 95%、±3σ: 99.7%（3シグマルール）", "相関係数ρ=−1：リスクをゼロにできる（理論上）", "ρ=+1：分散効果なし、リスクは加重平均に等しい", "σ（リスク）とμ（平均）は正規分布を完全に決める2つの数"]
  }));
}
...
function BasicsSectionF({
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(InfoBox, {
    ...
    den: {
      label: "EPS（Earnings Per Share：純利益÷株数）",
      src: "P/L",
      srcColor: PL
    },
    ...
    den: {
      label: "BPS（Book-value Per Share：自己資本÷株数）",
      src: "B/S",
      srcColor: BS
    },
...
function PVSection({
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
  ...
  }, "\u23F0 \u300C\u4ECA\u306E1\u4E07\u5186\u300D\u3068\u300C1\u5E74\u5F8C\u306E1\u4E07\u5186\u300D\u3069\u3061\u3089\u304C\u5F97\uFF1F"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      color: COLORS.text,
      lineHeight: 1.9,
  ...
  }, "\u540C\u30581\u4E07\u5186\u3067\u3082\u3001", /*#__PURE__*/React.createElement("strong", null, "\u4ECA\u3082\u3089\u3046\u65B9\u304C\u4FA1\u5024\u304C\u9AD8\u3044"), "\uFF01", /*#__PURE__*/React.createElement("br", null), "\u306A\u305C\u306A\u3089\u4ECA\u3082\u3089\u3048\u3070\u9280\u884C\u306B\u9810\u3051\u3066\u5897\u3084\u305B\u308B\u304B\u3089\u3002\u3053\u306E\u8003\u3048\u65B9\u3092", /*#__PURE__*/React.createElement("strong", {
    style: {
      color
    }
  }, "\u304A\u91D1\u306E\u6642\u9593\u4FA1\u5024"), "\u3068\u3044\u3044\u307E\u3059\u3002"), /*#__PURE__*/React.createElement("div", {
    style: {
      background: color + "10",
      borderRadius: 12,
      padding: "12px 14px",
  ...
  }, "\u25BC \u5E74\u52293%\u306E\u3068\u304D"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      gap: 8,
  ...
  }, "\u4ECA \u3082\u3089\u3046"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontWeight: 900,
      fontSize: 18
    }
  }, "10,000\u5186"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10,
      color: COLORS.textLight
    }
  }, "\u9280\u884C\u306B\u5165\u308C\u308B\u3068\u2026")), /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: "center"
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "1\u5E74\u5F8C")), /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: "center",
      background: "#fff",
      borderRadius: 12,
  ...
  }, "1\u5E74\u5F8C\u306B\u540C\u984D"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontWeight: 900,
      fontSize: 18
    }
  }, "10,300\u5186"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10,
      color: COLORS.textLight
    }
  }, "+300\u5186\u306E\u5229\u606F"))), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 10,
      fontSize: 12,
      color: COLORS.text,
  ...
  }, "\u3064\u307E\u308A\u300C1\u5E74\u5F8C\u306E10,000\u5186\u300D\u306E\u4ECA\u306E\u4FA1\u5024\u306F ", /*#__PURE__*/React.createElement("strong", {
    style: {
      color
    }
  }, "10,000 \xF7 1.03 \u2248 9,709\u5186"), " \u3067\u3059\u3002"))), /*#__PURE__*/React.createElement("div", {
    style: {
      ...STYLES.card,
      marginBottom: 12
    }
  ...
  }, "\uD83D\uDCD0 STEP 1\uFF5C\u73FE\u5728\u4FA1\u5024\uFF08PV\uFF09\u3068\u5C06\u6765\u4FA1\u5024\uFF08FV\uFF09"), /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 12
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "\u73FE\u5728\u4FA1\u5024", /*#__PURE__*/React.createElement("br", null), "\uFF08Present Value\uFF09")), /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: "center",
      padding: "0 4px",
      fontSize: 11,
  ...
  }, /*#__PURE__*/React.createElement("div", null, "\xD7 (1+r)\u207F \u2192"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 18
    }
  }, "\u2194"), /*#__PURE__*/React.createElement("div", null, "\u2190 \xF7 (1+r)\u207F")), /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: "center",
      background: COLORS.secondary + "15",
  ...
  }, "\u5C06\u6765\u4FA1\u5024", /*#__PURE__*/React.createElement("br", null), "\uFF08Future Value\uFF09")))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 8
  ...
  }, "\u73FE\u5728\u4FA1\u5024\u3092\u6C42\u3081\u308B\uFF08\u5272\u308A\u5F15\u304F\uFF09"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 14,
      fontWeight: 900,
      color,
  ...
  }, "PV = FV \xF7 (1 + r)\u207F"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      color: COLORS.text
    }
  }, "\u300Cn\u5E74\u5F8C\u306EFV\u5186\u306F\u3001\u4ECA\u3044\u304F\u3089\u306E\u4FA1\u5024\uFF1F\u300D\u3092\u8A08\u7B97")), /*#__PURE__*/React.createElement("div", {
    style: {
      background: "#F8F5FF",
      borderRadius: 12,
      padding: "10px 14px"
  ...
  }, "\u5C06\u6765\u4FA1\u5024\u3092\u6C42\u3081\u308B\uFF08\u5897\u3084\u3059\uFF09"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 14,
      fontWeight: 900,
      color: COLORS.secondary,
  ...
  }, "FV = PV \xD7 (1 + r)\u207F"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      color: COLORS.text
    }
  }, "\u300C\u4ECA\u306EPV\u5186\u3092\u3001n\u5E74\u5F8C\u306B\u3044\u304F\u3089\u306B\u5897\u3084\u305B\u308B\uFF1F\u300D\u3092\u8A08\u7B97"))), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 10,
      display: "flex",
      flexDirection: "column",
  ...
  }, "\uD83D\uDCBC STEP 2\uFF5CNPV\uFF08\u6B63\u5473\u73FE\u5728\u4FA1\u5024\uFF09\u2015 \u6295\u8CC7\u3059\u3079\u304D\u304B\uFF1F"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      color: COLORS.text,
      lineHeight: 1.8,
  ...
  }, "\u300C\u3053\u306E\u6A5F\u68B0\u3092\u8CB7\u3046\u3079\u304D\u304B\uFF1F\u300D\u3092\u5224\u65AD\u3059\u308B\u306E\u306B\u4F7F\u3044\u307E\u3059\u3002", /*#__PURE__*/React.createElement("br", null), "\u5C06\u6765\u5165\u3063\u3066\u304F\u308B\u304A\u91D1\u3092\u5168\u90E8\u300C\u4ECA\u306E\u4FA1\u5024\u300D\u306B\u76F4\u3057\u3001\u521D\u671F\u6295\u8CC7\u3068\u6BD4\u3079\u307E\u3059\u3002"), /*#__PURE__*/React.createElement("div", {
    style: {
    ...
    }, cfs.map((cf, i) => /*#__PURE__*/React.createElement("div", {
      key: i,
      style: {
        display: "flex",
        justifyContent: "space-between",
    ...
    }, i + 1, "\u5E74\u5F8C\u306B ", cf, "\u4E07\u5186\u5165\u308B"), /*#__PURE__*/React.createElement("span", {
      style: {
        fontWeight: 700,
        color
      }
    }, "\u4ECA\u306E\u4FA1\u5024: ", pvs[i].toFixed(1), "\u4E07\u5186"))), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        justifyContent: "space-between",
        background: "#fff",
    ...
    }, "PV\u5408\u8A08"), /*#__PURE__*/React.createElement("span", {
      style: {
        fontWeight: 700,
        color
      }
    }, pvs.reduce((s, v) => s + v, 0).toFixed(1), "\u4E07\u5186")), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        justifyContent: "space-between",
        background: "#fff",
    ...
    }, "\u521D\u671F\u6295\u8CC7"), /*#__PURE__*/React.createElement("span", {
      style: {
        fontWeight: 700,
        color: COLORS.danger
      }
    }, "\u2212100\u4E07\u5186")), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        justifyContent: "space-between",
        background: npv >= 0 ? COLORS.secondary + "20" : COLORS.danger + "15",
        borderRadius: 8,
        padding: "8px 10px",
        border: `1.5px solid ${npv >= 0 ? COLORS.secondary : COLORS.danger}50`
      }
    }, /*#__PURE__*/React.createElement("span", {
      style: {
        fontWeight: 800,
    ...
    }, "NPV ="), /*#__PURE__*/React.createElement("span", {
      style: {
        fontWeight: 900,
        fontSize: 16,
        color: npv >= 0 ? COLORS.secondary : COLORS.danger
      }
    }, npv.toFixed(1), "\u4E07\u5186 \u2192 ", npv >= 0 ? "✅ 投資すべき！" : "❌ 見送り")));
  })()), /*#__PURE__*/React.createElement("div", {
    style: {
      background: "#F8F5FF",
      borderRadius: 12,
  ...
  }, "NPV = \u03A3[CFt \xF7 (1+r)\u1D57] \u2212 \u521D\u671F\u6295\u8CC7"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 12,
      fontSize: 12
  ...
  }, "\u2705 NPV > 0 \u2192 \u6295\u8CC7OK"), /*#__PURE__*/React.createElement("span", {
    style: {
      color: COLORS.danger
    }
  }, "\u274C NPV < 0 \u2192 \u6295\u8CC7\u898B\u9001\u308A")))), /*#__PURE__*/React.createElement(CalcComponent, {
    formulaName: "\uD83E\uDDEE \u73FE\u5728\u4FA1\u5024\u30FB\u5C06\u6765\u4FA1\u5024\u8A08\u7B97\u6A5F",
    accentColor: color,
    inputs: [{
      label: "将来価値 FV（Future Value）",
      key: "fv",
      unit: "万円",
      defaultValue: "100"
    }, {
...
function StatsSection({
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
  ...
  }, "\uD83C\uDFB2 VaR\uFF08\u30D0\u30EA\u30E5\u30FC\u30FB\u30A2\u30C3\u30C8\u30FB\u30EA\u30B9\u30AF\uFF09\u3068\u306F\uFF1F"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      color: COLORS.text,
      lineHeight: 1.9,
  ...
  }, "\u300C", /*#__PURE__*/React.createElement("strong", null, "100\u65E5\u9593\u306E\u3046\u3061\u3001\u6700\u60AA\u4F55\u65E5\u304B\u306F\u5927\u304D\u304F\u640D\u3059\u308B\u304B"), "\u300D\u3092\u6570\u5024\u3067\u793A\u3057\u305F\u3082\u306E\u3067\u3059\u3002"), /*#__PURE__*/React.createElement("div", {
    style: {
      background: COLORS.danger + "10",
      borderRadius: 12,
      padding: "12px 14px",
  ...
  }, "\uD83D\uDDD3\uFE0F 95%VaR \u306E\u610F\u5473\u3092\u56F3\u3067\u7406\u89E3\u3057\u3088\u3046"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 4,
      flexWrap: "wrap",
  ...
  }, i < 19 ? "✓" : "✗"))), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: COLORS.text,
      lineHeight: 1.7
    }
  }, "20\u65E5\u9593\u306E\u3046\u306119\u65E5\u306F\u2713\uFF08\u6B63\u5E38\u7BC4\u56F2\uFF09\u3001", /*#__PURE__*/React.createElement("strong", {
    style: {
      color: COLORS.danger
    }
  }, "1\u65E5\u306F\u2717\uFF08\u640D\u5931\u304C\u5927\u304D\u3044\uFF09"), /*#__PURE__*/React.createElement("br", null), "\u3053\u308C\u304C\u300C95%\u306E\u78BA\u7387\u3067\u640D\u5931\u306F\u25CB\u25CB%\u4EE5\u5185\u300D\u3068\u3044\u3046\u610F\u5473\u3067\u3059\u3002")), /*#__PURE__*/React.createElement("div", {
    style: {
      background: "#F8F5FF",
      borderRadius: 12,
      padding: "12px 14px",
  ...
  }, "\u516C\u5F0F\uFF08\u6B63\u898F\u5206\u5E03\u3092\u4EEE\u5B9A\uFF09"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 14,
      fontWeight: 900,
      color,
  ...
  }, "95%VaR = \u03BC \u2212 1.645 \xD7 \u03C3"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 4,
  ...
  }, "\u4F8B\uFF1A\u03BC=5%\u3001\u03C3=15%\u306E\u3068\u304D"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      lineHeight: 1.8
    }
  }, "95%VaR = 5% \u2212 1.645 \xD7 15% = ", /*#__PURE__*/React.createElement("strong", {
    style: {
      color: COLORS.danger,
      fontSize: 16
    }
  }, "\u221219.7%")), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: COLORS.text,
      marginTop: 6,
  ...
  }, "\u300C100\u65E5\u306E\u3046\u306195\u65E5\u306F \u221219.7%\u4EE5\u5185\u306E\u640D\u5931\u300D", /*#__PURE__*/React.createElement("br", null), "\u300C\u6B8B\u308A5\u65E5\u306F\u221219.7%\u3092\u8D85\u3048\u308B\u640D\u5931\u304C\u51FA\u308B\u53EF\u80FD\u6027\u304C\u3042\u308B\u300D"))), /*#__PURE__*/React.createElement("div", {
    style: {
      ...STYLES.card,
      marginBottom: 12
    }
  ...
  }, "\u26A1 \u30B7\u30E3\u30FC\u30D7\u30EC\u30B7\u30AA \u2015 \u30EA\u30B9\u30AF\u5BFE\u6BD4\u306E\u30B3\u30B9\u30D1"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
      color: COLORS.text,
      lineHeight: 1.9,
  ...
  }, "\u300C\u30EA\u30B9\u30AF\u30921%\u53D6\u3063\u305F\u3068\u304D\u3001\u3069\u308C\u3060\u3051\u4F59\u5206\u306A\u30EA\u30BF\u30FC\u30F3\u3092\u7A3C\u3052\u308B\u304B\uFF1F\u300D\u306E\u30B3\u30B9\u30D1\u6307\u6A19\u3067\u3059\u3002"), /*#__PURE__*/React.createElement("div", {
    style: {
      background: COLORS.accent + "12",
      borderRadius: 12,
      padding: "12px 14px",
  ...
  }, "\uD83C\uDF54 \u98DF\u3079\u7269\u3067\u4F8B\u3048\u308B\u3068\u2026"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 8,
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, "\u30EA\u30BF\u30FC\u30F3", rp, "%\u3001\u30EA\u30B9\u30AF", sp, "%")), /*#__PURE__*/React.createElement("div", {
      style: {
        textAlign: "right"
      }
    }, /*#__PURE__*/React.createElement("div", {
      ...
      style: {
        fontWeight: 900,
        fontSize: 16,
        color: Number(sr) >= 0.5 ? COLORS.secondary : COLORS.accent
      }
    }, sr)));
  })), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "\u30EA\u30BF\u30FC\u30F3\u304C\u9AD8\u304F\u3066\u3082\u30EA\u30B9\u30AF\u304C\u5927\u304D\u3051\u308C\u3070\u30B3\u30B9\u30D1\u60AA\u3002", /*#__PURE__*/React.createElement("strong", null, "SR\u304C\u9AD8\u3044\u65B9\u304C\u52B9\u7387\u7684\u306A\u6295\u8CC7"), "\u3067\u3059\u3002")), /*#__PURE__*/React.createElement("div", {
    style: {
      background: "#F8F5FF",
      borderRadius: 12,
      padding: "10px 14px",
  ...
  }, "SR = (Rp \u2212 Rf) \xF7 \u03C3p"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 4,
  ...
  }, "SR \u2265 1.0"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      color: COLORS.text
    }
  }, "\u512A\u826F\u30D5\u30A1\u30F3\u30C9\u306E\u76EE\u5B89")), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: 1,
      background: COLORS.danger + "12",
      borderRadius: 10,
  ...
  }, "SR < 0"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      color: COLORS.text
    }
  }, "\u8D85\u904E\u30EA\u30BF\u30FC\u30F3\u304C\u30DE\u30A4\u30CA\u30B9")))), /*#__PURE__*/React.createElement(CalcComponent, {
...
function ProductsSectionA({
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(InfoBox, {
    ...
    inputs: [{
      ...
      label: "EPS（Earnings Per Share：1株利益）",
      key: "eps",
      unit: "円",
      defaultValue: "150"
    }, {
      label: "BPS（Book-value Per Share：1株純資産）",
      key: "bps",
      unit: "円",
      defaultValue: "1200"
    }, {
...
// --- ⑤ケーススタディタブ本体（公式問題集8セクション対応）---
const CASESTUDY_SECTIONS = [{
  id: "CS1",
  label: "CS1: リバランス提案"
}, {
  id: "CS2",
...
function CaseStudyTab({
  ...
  const [section, setSection] = useState("CS1");
  const color = "#8E44AD";
  useEffect(() => {
    const nt = state.navTarget;
    if (nt?.tab === "casestudy" && nt?.sec) {
      setSection(nt.sec);
      setState(s => ({
        ...s,
        navTarget: null
  ...
  useEffect(() => {
    if (state.visitedSections?.casestudy?.[section]) return;
    setState(s => ({
      ...s,
      visitedSections: {
        ...s.visitedSections,
        casestudy: {
          ...(s.visitedSections?.casestudy ?? {}),
          [section]: true
        }
      }
    }));
  }, [section]);
  const quizzes = CASESTUDY_QUIZZES[section] || [];
  const done = state.progress?.casestudy?.[section] ?? false;
  const quizKey = `_quizOpenCS${section}`;
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(WeakQuestionsPanel, {
    tabIds: ["casestudy"],
    state: state,
    setState: setState
  }), /*#__PURE__*/React.createElement(SectionTab, {
    sections: CASESTUDY_SECTIONS,
    activeSection: section,
    onSelect: setSection,
    color: color
  }), /*#__PURE__*/React.createElement(SectionProgress, {
    ...
    title: CASESTUDY_SECTIONS.find(s => s.id === section)?.label ?? "ケーススタディ",
    color: color,
    youtubeQuery: section === "CS1" ? "ポートフォリオ リバランス 方法 タイミング" : section === "CS2" ? "ドルコスト平均法 積立投資 効果" : section === "CS3" ? "投資信託 基準価額 計算方法" : section === "CS4" ? "DDM 配当割引モデル 理論株価 計算" : section === "CS5" ? "社債 発行条件 利回り 格付け" : section === "CS6" ? "ポートフォリオ効果 分散投資 相関係数" : section === "CS7" ? "シャープレシオ インフォメーションレシオ 運用評価" : "投資信託 分配金 普通分配金 特別分配金 課税"
  }, section === "CS1" && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("strong", null, "\u30EA\u30D0\u30E9\u30F3\u30B9\u3068\u306F\uFF1A"), "\u8CC7\u7523\u4FA1\u683C\u306E\u5909\u52D5\u3067\u5D29\u308C\u305F\u76EE\u6A19\u914D\u5206\u6BD4\u7387\u3092\u5143\u306B\u623B\u3059\u3053\u3068\u3002", /*#__PURE__*/React.createElement("br", null), "\u5B9A\u671F\u30EA\u30D0\u30E9\u30F3\u30B9\uFF08\u534A\u5E74\u30FB1\u5E74\uFF09\u307E\u305F\u306F\u4E56\u96E2\u5EA6\u30EA\u30D0\u30E9\u30F3\u30B9\uFF085%\u4EE5\u4E0A\u30BA\u30EC\u305F\u3068\u304D\uFF09\u304C\u4E00\u822C\u7684\u3002"), section === "CS2" && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("strong", null, "\u30C9\u30EB\u30B3\u30B9\u30C8\u5E73\u5747\u6CD5\uFF1A"), "\u6BCE\u6708\u4E00\u5B9A\u91D1\u984D\u3092\u6295\u8CC7\u3057\u7D9A\u3051\u308B\u65B9\u6CD5\u3002", /*#__PURE__*/React.createElement("br", null), "\u30B3\u30B9\u30C8\u306E\u300C\u6700\u5C0F\u5316\u300D\u3067\u306F\u306A\u304F\u300C\u5E73\u6E96\u5316\u300D\u304C\u76EE\u7684\u3002\u9AD8\u5024\u3065\u304B\u307F\u30EA\u30B9\u30AF\u3092\u8EFD\u6E1B\u3059\u308B\u3002"), section === "CS3" && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("strong", null, "\u57FA\u6E96\u4FA1\u984D\uFF08NAV\uFF09\uFF1A"), "\u7D14\u8CC7\u7523\u7DCF\u984D \xF7 \u7DCF\u53E3\u6570 \xD7 10,000\uFF081\u4E07\u53E3\u5F53\u305F\u308A\uFF09", /*#__PURE__*/React.createElement("br", null), "\u5206\u914D\u91D1\u652F\u6255\u3044\u5F8C\u306F\u57FA\u6E96\u4FA1\u984D\u304C\u4E0B\u843D\u3059\u308B\u3002\u30C8\u30FC\u30BF\u30EB\u30EA\u30BF\u30FC\u30F3\uFF08\u5206\u914D\u91D1\u8FBC\u307F\uFF09\u3067\u8A55\u4FA1\u3059\u308B\u3053\u3068\u3002"), section === "CS4" && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("strong", null, "\u30BC\u30ED\u6210\u9577DDM\uFF1A"), "P = D \xF7 r\uFF08\u914D\u5F53\u4E00\u5B9A\uFF09", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("strong", null, "\u5B9A\u7387\u6210\u9577DDM\uFF1A"), "P = D1 \xF7 (r \u2212 g)\uFF08\u914D\u5F53\u304Cg%\u6210\u9577\u3001r > g \u304C\u5FC5\u8981\uFF09", /*#__PURE__*/React.createElement("br", null), "\u4E21\u30E2\u30C7\u30EB\u306E\u9055\u3044\u306F\u983B\u51FA\u3072\u3063\u304B\u3051\u3002"), section === "CS5" && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("strong", null, "\u793E\u50B5\u306E\u30EA\u30B9\u30AF\u30D7\u30EC\u30DF\u30A2\u30E0\uFF1A"), "\u793E\u50B5\u5229\u56DE\u308A = \u56FD\u50B5\u5229\u56DE\u308A + \u4FE1\u7528\u30B9\u30D7\u30EC\u30C3\u30C9\uFF08\u683C\u4ED8\u3051\u306B\u5FDC\u3058\u305F\u4E0A\u4E57\u305B\uFF09", /*#__PURE__*/React.createElement("br", null), "\u91D1\u5229\u4E0A\u6607 \u2192 \u65E2\u5B58\u793E\u50B5\u4FA1\u683C\u4E0B\u843D\uFF08\u9006\u76F8\u95A2\uFF09\u3002\u30C7\u30E5\u30EC\u30FC\u30B7\u30E7\u30F3\u304C\u9577\u3044\u307B\u3069\u5F71\u97FF\u5927\u3002"), section === "CS6" && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("strong", null, "\u30DD\u30FC\u30C8\u30D5\u30A9\u30EA\u30AA\u52B9\u679C\uFF1A"), "\u76F8\u95A2\u4FC2\u6570 < +1 \u306E2\u8CC7\u7523\u3092\u7D44\u307F\u5408\u308F\u305B\u308B\u3068\u3001\u30EA\u30B9\u30AF\u306F\u5358\u7D14\u52A0\u91CD\u5E73\u5747\u3092\u4E0B\u56DE\u308B\u3002", /*#__PURE__*/React.createElement("br", null), "\u76F8\u95A2\u304C\u4F4E\u3044\u307B\u3069\u52B9\u679C\u5927\u3002\u76F8\u95A2=+1\u3067\u306F\u52B9\u679C\u30BC\u30ED\u3001\u76F8\u95A2=\u22121\u3067\u306F\u7406\u8AD6\u4E0A\u30BC\u30ED\u306B\u3067\u304D\u308B\u3002"), section === "CS7" && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("strong", null, "\u30B7\u30E3\u30FC\u30D7\u30EC\u30B7\u30AA\uFF1A"), "(Rp \u2212 Rf) \xF7 \u03C3p\uFF08\u7DCF\u30EA\u30B9\u30AF1\u5358\u4F4D\u3042\u305F\u308A\u306E\u8D85\u904E\u30EA\u30BF\u30FC\u30F3\uFF09", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("strong", null, "\u30A4\u30F3\u30D5\u30A9\u30E1\u30FC\u30B7\u30E7\u30F3\u30EC\u30B7\u30AA\uFF1A"), "\u8D85\u904E\u30EA\u30BF\u30FC\u30F3 \xF7 \u30C8\u30E9\u30C3\u30AD\u30F3\u30B0\u30A8\u30E9\u30FC\uFF08\u30A2\u30AF\u30C6\u30A3\u30D6\u904B\u7528\u306E\u52B9\u7387\u6027\uFF09", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("strong", null, "\u30C8\u30EC\u30A4\u30CA\u30FC\u30EC\u30B7\u30AA\uFF1A"), "(Rp \u2212 Rf) \xF7 \u03B2\uFF08\u5E02\u5834\u30EA\u30B9\u30AF1\u5358\u4F4D\u3042\u305F\u308A\uFF09"), section === "CS8" && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("strong", null, "\u666E\u901A\u5206\u914D\u91D1\uFF1A"), "\u904B\u7528\u76CA\u304B\u3089\u652F\u6255\u3044 \u2192 ", /*#__PURE__*/React.createElement("strong", null, "\u8AB2\u7A0E\u5BFE\u8C61\uFF0820.315%\uFF09"), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("strong", null, "\u7279\u5225\u5206\u914D\u91D1\uFF1A"), "\u5143\u672C\u6255\u623B\u91D1 \u2192 ", /*#__PURE__*/React.createElement("strong", null, "\u975E\u8AB2\u7A0E"), /*#__PURE__*/React.createElement("br", null), "\u5224\u5225\uFF1A\u5206\u914D\u5F8C\u57FA\u6E96\u4FA1\u984D vs \u53D6\u5F97\u5358\u4FA1\u3092\u6BD4\u8F03\u3059\u308B\u3002")), /*#__PURE__*/React.createElement("button", {
    style: {
      ...(done ? STYLES.btnSecondary : STYLES.btnPrimary),
      width: "100%",
      marginBottom: 12,
  ...
  }), "\u5B8C\u4E86\u6E08\u307F \u2014 \u518D\u6311\u6226\u3059\u308B") : `${CASESTUDY_SECTIONS.find(s => s.id === section)?.label ?? section} テスト（${quizzes.length}問）を開始`), state[quizKey] && /*#__PURE__*/React.createElement(QuizComponent, {
    quizzes: quizzes,
    tabId: "casestudy",
    sectionId: section,
    accentColor: color,
    ...
    progressField: "progress",
    onNext: (() => {
      const idx = CASESTUDY_SECTIONS.findIndex(s => s.id === section);
      const next = CASESTUDY_SECTIONS[idx + 1];
      return next ? () => setSection(next.id) : undefined;
    })()
  }));
}
...
function AnalysisSectionA({
  ...
  const TAB_SECTIONS = {
    ...
    products: ["A", "B", "C", "D", "E"],
    supp2: ["A"],
    casestudy: ["CS1", "CS2", "CS3", "CS4", "CS5", "CS6", "CS7", "CS8"]
  };
  const sectionData = [];
...
function buildMockQuestions() {
  ...
  // ケーススタディ
  const casePool = Object.entries(CASESTUDY_QUIZZES).flatMap(([sec, qs]) => qs.map(q => ({
    ...q,
    tab: "casestudy",
    section: sec
  })));
...
const CALC_QUIZ_MAP = [{
  ...
  tab: "basics",
  sec: "D",
  quizzes: BASICS_QUIZZES.D.filter(q => q.isCalc)
}, {
  tab: "basics",
  sec: "E",
  quizzes: BASICS_QUIZZES.E.filter(q => q.isCalc)
}, {
  tab: "portfolio",
  sec: "A",
...
const FLASH_QUIZ_MAP = [{
  ...
  tab: "basics",
  sec: "D",
  label: "②基礎 D：債券・リスクプレミアム",
  quizzes: BASICS_QUIZZES.D
}, {
  tab: "basics",
  sec: "E",
  label: "②基礎 E：72の法則・実質価値",
  quizzes: BASICS_QUIZZES.E
}, {
  tab: "portfolio",
  sec: "A",
  label: "③ポートフォリオ理論 A：分散効果",
  quizzes: PORTFOLIO_QUIZZES.A
}, {
  tab: "portfolio",
  sec: "B",
...
function HomeTab({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, startedChapSecs, "/", totalChapSecs, " \u5B66\u7FD2\u6E08")), /*#__PURE__*/React.createElement("div", {
      style: {
        height: 8,
        background: COLORS.border,
        borderRadius: 8,
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        style: {
          fontSize: 10,
          fontWeight: 700,
          color: allDone ? COLORS.secondary : ch.started > 0 ? ch.color : COLORS.textLight,
          flexShrink: 0,
          marginLeft: 4
        }
      }, ch.started, "/", ch.all)), /*#__PURE__*/React.createElement("div", {
        style: {
          height: 4,
          background: COLORS.border,
          borderRadius: 4,
        ...
        style: {
          ...
          height: 14,
          borderRadius: 4,
          background: v === true ? allDone ? COLORS.secondary : ch.color : v === "v" ? ch.color + "44" : COLORS.border,
          border: v === "v" ? `1px solid ${ch.color}88` : "none",
          display: "flex",
          alignItems: "center",
          justifyContent: "center"
        }
      }, v === true && /*#__PURE__*/React.createElement(Check, {
        size: 9,
        color: "#fff"
...
(function(){const c=document.getElementById('root');if(!c)return;ReactDOM.createRoot(c).render(React.createElement(ABCExamApp));})();