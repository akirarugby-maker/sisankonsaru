...
const INITIAL_PROGRESS = {
  ...
  casestudy: { CS1: false, CS2: false, CS3: false, CS4: false, CS5: false, CS6: false, CS7: false, CS8: false },
  ...
  try {
    ...
    return {
      ...
      visitedSections: {
        ...
        casestudy: { ...(saved.visitedSections?.casestudy ?? {}) },
      },
...
const CHAPTERS_META = [
  ...
  { id: "ch3",   num: "第3章",  title: "資産運用と税制",          subtitle: "NISA（Nippon Individual Savings Account：少額投資非課税制度）・iDeCo（individual-type Defined Contribution pension：個人型確定拠出年金）・税制優遇", color: "#E67E22", tabId: "ethics",    sections: { A: "税制・口座" } },
  ...
  { id: "ch6",   num: "第6章",  title: "財務諸表の活用",          subtitle: "PER（Price Earnings Ratio：株価収益率）・PBR（Price Book-value Ratio：株価純資産倍率）・ROE（Return on Equity：自己資本利益率）・財務分析", color: "#27AE60", tabId: "basics",    sections: { A: "財務諸表" } },
  { id: "ch7",   num: "第7章",  title: "ポートフォリオ理論",      subtitle: "相関係数・分散効果・効率的ポートフォリオ（Efficient Portfolio：最小リスクで最大リターンを実現する組合せ）", color: "#8E44AD", tabId: "portfolio", sections: { A: "分散効果", B: "市場線" } },
  { id: "ch8",   num: "第8章",  title: "CAPM（Capital Asset Pricing Model：資本資産評価モデル）・評価モデル", subtitle: "ベータ・シャープレシオ・情報レシオ（Information Ratio：超過収益÷追跡誤差）", color: "#C0392B", tabId: "portfolio", sections: { A: "CAPM", B: "評価指標" } },
  { id: "ch9",   num: "第9章",  title: "株式投資",                subtitle: "PER（Price Earnings Ratio：株価収益率）・PBR（Price Book-value Ratio：株価純資産倍率）・DDM（Dividend Discount Model：配当割引モデル）", color: "#2ECC71", tabId: "products",  sections: { A: "株式評価" } },
  ...
  { id: "ch12",  num: "第12章", title: "投資信託",                subtitle: "アクティブ・パッシブ・ESG（Environmental, Social, Governance：環境・社会・企業統治）", color: "#F39C12", tabId: "products",  sections: { A: "投資信託" } },
  { id: "supp2", num: "補論2",  title: "デリバティブ取引",        subtitle: "先物・オプション・スワップ",       color: "#E74C3C", tabId: "products",  sections: { A: "デリバティブ" } },
  { id: "supp3", num: "補論3",  title: "オルタナティブ（Alternative：代替投資）", subtitle: "REIT（Real Estate Investment Trust：不動産投資信託）・ヘッジファンド・不動産", color: "#95A5A6", tabId: "products",  sections: { A: "オルタナティブ" } },
];
...
const PORTFOLIO_QUIZZES = {
  ...
  D: [
    ...
    },
    {
      ...
      choices: [
        "トレイナーは総リスク（σ）、シャープは市場リスク（β）を分母に使う",
        "トレイナーは市場リスク（β）、シャープは総リスク（σ）を分母に使う",
        "両者は全く同じ指標",
        "トレイナーはベンチマーク比較、シャープは絶対的評価",
      ],
      answer: 1,
    ...
    },
    {
      ...
      choices: [
        "ベンチマークに比べてリターンが低い",
        "トラッキングエラーが大きいほど情報レシオは高くなる",
        "ベンチマーク超過リターンが高く、かつトラッキングエラーが小さい",
        "インデックスファンドほど情報レシオが高い",
      ],
      answer: 2,
...
const PRODUCTS_QUIZZES = {
  A: [
    ...
    },
    {
      ...
      choices: [
        "正しい。PERは株価÷1株当たり自己資本で計算する",
        "誤り。それはPBRの説明であり、PERは株価÷1株当たり純利益で計算する",
        "正しい。PERとPBRは同じ指標である",
        "誤り。PERは純利益÷株価で計算する",
      ],
      answer: 1,
    ...
    },
    {
      ...
      q: "公募増資について正しいものはどれか？",
      choices: [
        "特定の投資家のみを対象に株式を募集することをいう",
        "不特定多数の投資家を対象に新株を発行し資金調達することをいう",
        "既存株主のみに無償で株式を割り当てることをいう",
        "社債を株式に転換することをいう",
      ],
      answer: 1,
  ...
  C: [
    ...
    },
    {
      ...
      choices: [
        "ヘッジありは為替リスクがなく、ヘッジコスト（金利差相当）がかかる",
        "ヘッジなしは為替リスクがなく安全",
        "ヘッジコストはゼロで必ず有利",
        "どちらも円建てリターンは同じ",
      ],
    ...
    },
    {
      ...
      choices: [
        "高金利通貨の先物レートは直物レートより高くなる",
        "高金利国通貨は将来的に金利差分だけ下落することが期待される（裁定なし条件）",
        "金利が高い国の通貨は必ず上昇する",
        "実際の市場でUIPは常に成立している",
      ],
      answer: 1,
    ...
    },
    {
      ...
      choices: [
        "先進国より経済成長が安定しているため、リスクは低い",
        "リターンの高さだけに着目して投資判断することは適当でない",
        "新興国株式は先進国株式と完全に逆相関のため分散に最適",
        "新興国債券は必ず投資適格格付けを持つ",
      ],
      answer: 1,
  ...
  D: [
    ...
    },
    {
      ...
      choices: [
        "Economy（経済）・Safety（安全）・Growth（成長）",
        "Environment（環境）・Social（社会）・Governance（ガバナンス）",
        "Earnings（収益）・Stability（安定性）・Growth（成長）",
        "Equity（株式）・Securities（証券）・Global（グローバル）",
      ],
      answer: 1,
    ...
    },
    {
      ...
      choices: [
        "ファンドラップは複数の投資信託に投資し、SMAは直接株式・債券に投資する一任運用",
        "ファンドラップとSMAは全く同じサービス",
        "SMAは投資信託のみに投資する",
        "ファンドラップは元本保証がある",
      ],
      answer: 0,
    ...
    },
    {
      ...
      choices: [
        "パッシブ運用は市場を分析し常に最適な銘柄を選択するため",
        "信託報酬・売買コストの差が長期的に大きな影響を与えるため",
        "アクティブ運用は規制により市場を上回ることが禁止されているため",
        "インデックスは下落することがないため",
      ],
      answer: 1,
  ...
  E: [
    ...
    },
    {
      ...
      choices: [
        "公募投資信託と同様に一般投資家向けに広く販売される",
        "空売りやレバレッジを活用し、市場環境に関わらず絶対リターンを狙う",
        "元本保証があり安全性が高い",
        "信託報酬はインデックスファンドと同水準",
      ],
      answer: 1,
    ...
    },
    {
      ...
      choices: [
        "J-REITの分配金利回りは通常株式配当利回りより低い",
        "J-REITは収益の90%超を分配するため、分配金利回りが高くなりやすい",
        "J-REITの分配金は非課税",
        "J-REITは分配金を出す義務がない",
      ],
      answer: 1,
    ...
    },
    {
      ...
      choices: [
        "株式・債券と相関が高く分散効果は限定的",
        "インフレヘッジ効果が期待でき、株式・債券との相関が低い場合がある",
        "元本保証があり安全な投資先",
        "配当・利子収入が安定的に得られる",
      ],
      answer: 1,
...
const CASESTUDY_QUIZZES = {
  CS1: [
    {
      ...
      choices: [
        "リターンを最大化するために集中投資に切り替えること",
        "資産価格の変動で崩れた目標配分比率を元の水準に戻すこと",
        "手数料収入を増やすために頻繁に売買すること",
        "損失が出た資産を売却して利益確定すること",
      ],
      answer: 1,
    ...
    },
    {
      ...
      choices: [
        "定期リバランス（半年・1年ごと）",
        "乖離度リバランス（目標比率から一定%以上ずれたとき）",
        "毎日リバランス（日次で実施）",
        "ライフイベント（退職・相続等）をきっかけにしたリバランス",
      ],
      answer: 2,
    ...
    },
    {
      ...
      choices: [
        "常にリターンが最大化される",
        "リスク水準を目標に維持しつつ、割高資産売・割安資産買の効果が期待できる",
        "リバランスにより元本保証が得られる",
        "すべての資産クラスの損失を防ぐことができる",
      ],
      answer: 1,
    ...
    },
    {
      ...
      choices: [
        "年齢が上がるほど株式比率を高め、リスクを取るべきである",
        "若い時期は株式比率を高め、退職が近づくにつれて債券比率を高める",
        "退職後は全資産を株式で運用すべきである",
        "年齢に関わらず常に同じ配分を維持すべきである",
      ],
      answer: 1,
    ...
    },
    {
      ...
      choices: [
        "リターンが常に低下する",
        "値上がりした資産の比率が高まりすぎてリスクが目標より大きくなる",
        "配当金が受け取れなくなる",
        "投資信託の基準価額が下落する",
      ],
      answer: 1,
    ...
    },
    {
      ...
      choices: [
        "両者は全く同じ行為である",
        "リバランスは目標比率への回帰であり、アロケーション変更は目標比率自体を変える戦略的判断",
        "アロケーション変更の方がコストが低い",
        "リバランスは年1回しか実施できない",
      ],
      answer: 1,
  ...
  CS2: [
    ...
    },
    {
      ...
      choices: [
        "購入コストを最小化（最も安く買う）効果がある",
        "購入コストを平準化する効果があり、高値づかみリスクを軽減する",
        "必ず利益を確保できる",
        "市場の最安値で購入できる",
      ],
      answer: 1,
    ...
    },
    {
      ...
      choices: [
        "どんな市場環境でもドルコスト平均法の方が優れている",
        "右肩上がりの上昇相場では一括投資の方が高いリターンを得られることが多い",
        "一括投資はドルコスト平均法より常にリスクが低い",
        "両者のリターンは常に同じになる",
      ],
      answer: 1,
    ...
    },
    {
      ...
      choices: [
        "すぐに解約して損失を確定させる",
        "積立を停止して様子を見る",
        "長期目線でドルコスト平均法の恩恵を活かしながら積立を継続する",
        "下落した分を一括で追加購入する",
      ],
      answer: 2,
  ...
  CS3: [
    ...
    },
    {
      ...
      choices: [
        "分配金を受け取ると基準価額が上昇するため",
        "分配金支払いで基準価額が下落するが受け取った分配金を含めた本当の収益を測るため",
        "分配金は税金がかかるため考慮する必要があるため",
        "分配金は基準価額に含まれているため",
      ],
      answer: 1,
    ...
    },
    {
      ...
      choices: [
        "毎月必ず運用益から分配金が支払われる",
        "分配頻度が高いほど長期複利効果が大きい",
        "分配金は運用状況によっては元本から支払われることがある（特別分配金）",
        "毎月分配型は税金がかからない",
      ],
      answer: 2,
    ...
    },
    {
      ...
      choices: [
        "純資産が大きいほど基準価額も必ず高くなる",
        "流動性が高く、運用コスト効率が良い場合が多い",
        "純資産が大きいほどリターンが保証される",
        "小規模ファンドの方が常に優れたパフォーマンスを示す",
      ],
      answer: 1,
  ...
  CS4: [
    {
      ...
      choices: [
        "配当が毎年一定割合で増加し続けることを前提とする",
        "配当が毎年一定額で永続的に支払われることを前提とする",
        "配当がゼロで純資産のみで評価する",
        "将来の配当はすべて割引率ゼロで評価する",
      ],
      answer: 1,
  ...
  CS5: [
    {
      ...
      choices: [
        "社債は国債より信用リスクが低い",
        "社債は発行企業の信用力によってリスクプレミアムが上乗せされた利回りとなる",
        "社債に元本保証はないが国債には元本保証がある",
        "社債の利回りは常に国債より低い",
      ],
      answer: 1,
    ...
    },
    {
      ...
      choices: [
        "BBB以上は元本保証がある",
        "投資適格債はデフォルトリスクが相対的に低く、BB以下は高リスク・高利回り（ハイイールド債）",
        "BB以下の債券は取引所で売買できない",
        "格付けが高いほど利回りが高い",
      ],
      answer: 1,
    ...
    },
    {
      ...
      choices: [
        "利回りはクーポン率3%と等しくなる",
        "発行価格が額面より低いため、利回りはクーポン率3%より高くなる",
        "発行価格が低いほど利回りは低くなる",
        "利回りはクーポン率に関係なく一定",
      ],
      answer: 1,
    ...
    },
    {
      ...
      choices: [
        "デュレーションが長いほど金利変動に対する価格感応度は低い",
        "デュレーションが長いほど金利変動に対する価格感応度は高い",
        "デュレーションは社債価格変動とは無関係",
        "クーポンが高いほどデュレーションは長くなる",
      ],
      answer: 1,
  ...
  CS6: [
    ...
    },
    {
      ...
      choices: [
        "リターンが最大のポートフォリオのみが効率的",
        "同じリスク水準で最大のリターン（または同じリターンで最小のリスク）を達成するポートフォリオの集合",
        "効率的フロンティア上の全ポートフォリオは同じリスクを持つ",
        "リスクゼロの無リスク資産の集合",
      ],
      answer: 1,
    ...
    },
    {
      ...
      choices: [
        "すべての国の資産は相関係数+1であるため安全",
        "各国の経済・市場が完全に連動しているため",
        "各国の経済サイクルや市場の動きが異なるため、相関が低く分散効果が期待できる",
        "外国資産は為替リスクがないため",
      ],
      answer: 2,
  ...
  CS7: [
    {
      ...
      choices: [
        "SR = ポートフォリオリターン ÷ 標準偏差",
        "SR = (ポートフォリオリターン − 無リスク金利) ÷ 標準偏差",
        "SR = (ポートフォリオリターン − ベンチマークリターン) ÷ トラッキングエラー",
        "SR = ポートフォリオリターン × ベータ",
      ],
      answer: 1,
    ...
    },
    {
      ...
      choices: [
        "無リスク金利は常にゼロのため計算に不要",
        "リスクを取らずに得られるリターンを超えた部分（リスクをとる対価）を評価するため",
        "法律で定められているため",
        "リターンをマイナスにするため",
      ],
      answer: 1,
    ...
    },
    {
      ...
      choices: [
        "IR = ポートフォリオリターン ÷ ベータ",
        "IR = (ポートフォリオリターン − ベンチマークリターン) ÷ トラッキングエラー",
        "IR = 超過リターン × 標準偏差",
        "IR = ベンチマークリターン ÷ 信託報酬",
      ],
      answer: 1,
    ...
    },
    {
      ...
      choices: [
        "両者は常に同じ結果になる",
        "シャープレシオは分散が効いた総リスク評価、トレイナーは市場リスク（β）のみで評価",
        "トレイナーレシオの方が常に優れた指標",
        "シャープレシオはアクティブ運用のみに使用する",
      ],
      answer: 1,
    ...
    },
    {
      ...
      choices: [
        "信託報酬を計算するため",
        "運用のパフォーマンスを市場全体（インデックス）と比較するため",
        "投資信託の純資産総額を算出するため",
        "分配金の支払い金額を決定するため",
      ],
      answer: 1,
    ...
    },
    {
      ...
      choices: [
        "リスクゼロのポートフォリオのリターン",
        "CAPMで期待されるリターンを上回った超過リターン（運用者の付加価値）",
        "市場ポートフォリオのリターン",
        "無リスク金利と市場リターンの差",
      ],
      answer: 1,
  ...
  CS8: [
    {
      ...
      choices: [
        "元本分配金と利益分配金の2種類",
        "普通分配金（運用益からの分配）と特別分配金（元本払戻金）の2種類",
        "毎月分配金と年1回分配金の2種類",
        "税前分配金と税後分配金の2種類",
      ],
      answer: 1,
    ...
    },
    {
      ...
      choices: [
        "分配金が100円以上なら普通分配金",
        "分配後の基準価額が取得単価を上回っていれば全額普通分配金、下回れば差額が特別分配金",
        "設定から1年以内は全て特別分配金",
        "アクティブ運用なら普通分配金、パッシブ運用なら特別分配金",
      ],
      answer: 1,
    ...
    },
    {
      ...
      choices: [
        "金額が少額だから",
        "自分が投資した元本の一部が戻ってきているだけで、利益が発生していないから",
        "投資信託は原則非課税だから",
        "特別分配金は信託報酬から支払われるから",
      ],
      answer: 1,
    ...
    },
    {
      ...
      choices: [
        "分配金が多いほど運用パフォーマンスが良い証拠となる",
        "頻繁な分配で元本が取り崩され、複利効果が損なわれる可能性がある",
        "毎月分配型は必ず特別分配金のみが支払われる",
        "毎月分配型は信託報酬がかからない",
      ],
      answer: 1,
    ...
    },
    {
      ...
      choices: [
        "分配金がないとリターンが高くなるから",
        "分配せず再投資することで複利効果が最大化され、税の繰り延べ効果もあるから",
        "分配金には元本を超えるコストがかかるから",
        "無分配型は信託報酬がゼロだから",
      ],
      answer: 1,
...
const ETHICS_SECTIONS = [
  { id: "A", label: "A: FD（Fiduciary Duty：受託者責任）原則" },
  { id: "B", label: "B: 信頼関係" },
  { id: "C", label: "C: 税制" },
  { id: "D", label: "D: 行動経済学" },
  { id: "E", label: "E: ゴールベース" },
...
const BASICS_SECTIONS_CDE = [
  { id: "C", label: "C: 現在価値" },
  { id: "D", label: "D: 統計・VaR（Value at Risk：予想最大損失額）" },
  { id: "E", label: "E: 資産配分" },
];
...
const PF_SECTIONS = [
  { id: "A", label: "A: 分散効果" },
  { id: "B", label: "B: 効率的フロンティア（Efficient Frontier：最適ポートフォリオ集合）" },
  { id: "C", label: "C: CAPM（Capital Asset Pricing Model：資本資産評価モデル）" },
  { id: "D", label: "D: 評価指標" },
];
...
const PRODUCTS_SECTIONS = [
  ...
  { id: "C", label: "C: 外国証券" },
  { id: "D", label: "D: 投資信託" },
  { id: "E", label: "E: オルタナティブ（Alternative：代替投資）" },
  { id: "F", label: "F: デリバティブ" },
];
...
const CASESTUDY_SECTIONS = [
  { id: "CS1", label: "CS1: リバランス提案" },
  { id: "CS2", label: "CS2: ドルコスト平均法" },
  { id: "CS3", label: "CS3: 基準価額の推移" },
  { id: "CS4", label: "CS4: 理論株価の計算" },
  { id: "CS5", label: "CS5: 社債と発行条件" },
  { id: "CS6", label: "CS6: ポートフォリオ効果" },
  { id: "CS7", label: "CS7: 収益率評価手法" },
  { id: "CS8", label: "CS8: 分配金と元本" },
];
...
function CaseStudyTab({ state, setState }) {
  ...
  useEffect(() => {
    ...
    setState(s => ({
      ...
      visitedSections: {
        ...s.visitedSections,
        casestudy: { ...(s.visitedSections?.casestudy ?? {}), [section]: true }
      }
    }));
  }, [section]);
  ...
  return (
    <div>
      <WeakQuestionsPanel tabIds={["casestudy"]} state={state} setState={setState} />
      <SectionTab sections={CASESTUDY_SECTIONS} activeSection={section} onSelect={setSection} color={color} />
      <SectionProgress tabId="casestudy" sections={CASESTUDY_SECTIONS} progress={state.progress} color={color} onSelect={setSection} />

      <InfoBox
        title={CASESTUDY_SECTIONS.find(s => s.id === section)?.label ?? "ケーススタディ"}
        color={color}
        youtubeQuery={
          section === "CS1" ? "ポートフォリオ リバランス 方法 タイミング" :
          section === "CS2" ? "ドルコスト平均法 積立投資 効果" :
          section === "CS3" ? "投資信託 基準価額 計算方法" :
          section === "CS4" ? "DDM 配当割引モデル 理論株価 計算" :
          section === "CS5" ? "社債 発行条件 利回り 格付け" :
          section === "CS6" ? "ポートフォリオ効果 分散投資 相関係数" :
          section === "CS7" ? "シャープレシオ インフォメーションレシオ 運用評価" :
          "投資信託 分配金 普通分配金 特別分配金 課税"
        }
      >
        {section === "CS1" && <>
          <strong>リバランスとは：</strong>資産価格の変動で崩れた目標配分比率を元に戻すこと。<br />
          定期リバランス（半年・1年）または乖離度リバランス（5%以上ズレたとき）が一般的。
        </>}
        {section === "CS2" && <>
          <strong>ドルコスト平均法：</strong>毎月一定金額を投資し続ける方法。<br />
          コストの「最小化」ではなく「平準化」が目的。高値づかみリスクを軽減する。
        </>}
        {section === "CS3" && <>
          <strong>基準価額（NAV）：</strong>純資産総額 ÷ 総口数 × 10,000（1万口当たり）<br />
          分配金支払い後は基準価額が下落する。トータルリターン（分配金込み）で評価すること。
        </>}
        {section === "CS4" && <>
          <strong>ゼロ成長DDM：</strong>P = D ÷ r（配当一定）<br />
          <strong>定率成長DDM：</strong>P = D1 ÷ (r − g)（配当がg%成長、r &gt; g が必要）<br />
          両モデルの違いは頻出ひっかけ。
        </>}
        {section === "CS5" && <>
          <strong>社債のリスクプレミアム：</strong>社債利回り = 国債利回り + 信用スプレッド（格付けに応じた上乗せ）<br />
          金利上昇 → 既存社債価格下落（逆相関）。デュレーションが長いほど影響大。
        </>}
        {section === "CS6" && <>
          <strong>ポートフォリオ効果：</strong>相関係数 &lt; +1 の2資産を組み合わせると、リスクは単純加重平均を下回る。<br />
          相関が低いほど効果大。相関=+1では効果ゼロ、相関=−1では理論上ゼロにできる。
        </>}
        {section === "CS7" && <>
          <strong>シャープレシオ：</strong>(Rp − Rf) ÷ σp（総リスク1単位あたりの超過リターン）<br />
          <strong>インフォメーションレシオ：</strong>超過リターン ÷ トラッキングエラー（アクティブ運用の効率性）<br />
          <strong>トレイナーレシオ：</strong>(Rp − Rf) ÷ β（市場リスク1単位あたり）
        </>}
        {section === "CS8" && <>
          <strong>普通分配金：</strong>運用益から支払い → <strong>課税対象（20.315%）</strong><br />
          <strong>特別分配金：</strong>元本払戻金 → <strong>非課税</strong><br />
          判別：分配後基準価額 vs 取得単価を比較する。
        </>}
      </InfoBox>
      ...
      >
        {done
          ? <><Check size={14} style={{ marginRight: 5 }} />完了済み — 再挑戦する</>
          : `${CASESTUDY_SECTIONS.find(s => s.id === section)?.label ?? section} テスト（${quizzes.length}問）を開始`
        }
      </button>
...
function AnalysisSectionA({ state }) {
  ...
  const RADAR_GROUPS = [
    ...
    { key: "g_pf",      label: "ポートフォリオ理論・CAPM（Capital Asset Pricing Model：資本資産評価モデル）", tabs: ["portfolio"] },
...
function AnalysisSectionD() {
  const topics = [
    { key: "capm",           label: "CAPM（Capital Asset Pricing Model：資本資産評価モデル）" },
    { key: "sharpe_ratio",   label: "シャープレシオ" },
    { key: "portfolio_risk", label: "ポートフォリオリスクと分散効果" },
    { key: "efficient_frontier", label: "効率的フロンティア（Efficient Frontier：最適ポートフォリオ集合）・CML（Capital Market Line：資本市場線）" },
    { key: "duration",       label: "デュレーション" },
    { key: "ddm",            label: "DDM（Dividend Discount Model：配当割引モデル）" },
    { key: "fd_principle",   label: "FD（Fiduciary Duty：受託者責任）" },
    { key: "nisa",           label: "新NISA（Nippon Individual Savings Account：少額投資非課税制度）" },
    { key: "ideco",          label: "iDeCo（individual-type Defined Contribution pension：個人型確定拠出年金）" },
  ];
...
function buildMockQuestions() {
  ...
  // ケーススタディ
  const casePool = Object.entries(CASESTUDY_QUIZZES).flatMap(([sec, qs]) =>
    qs.map(q => ({ ...q, tab: "casestudy", section: sec }))
  );
...
const ALL_CALC_QUIZZES = [
  ...
  ...Object.values(CASESTUDY_QUIZZES).flat().filter((q) => q.isCalc),
];
...
const FLASH_QUIZ_MAP = [
  ...
  { tab: "basics",    sec: "C", label: "②基礎 C：現在価値・VaR（Value at Risk：予想最大損失額）", quizzes: BASICS_QUIZZES.C },
  ...
  { tab: "portfolio", sec: "B", label: "③ポートフォリオ理論 B：効率的フロンティア（Efficient Frontier：最適ポートフォリオ集合）",          quizzes: PORTFOLIO_QUIZZES.B },
  { tab: "portfolio", sec: "C", label: "③ポートフォリオ理論 C：CAPM（Capital Asset Pricing Model：資本資産評価モデル）・ベータ", quizzes: PORTFOLIO_QUIZZES.C },
  ...
  { tab: "products",  sec: "D", label: "④金融商品 D：投信・ETF（Exchange Traded Fund：上場投資信託）",             quizzes: PRODUCTS_QUIZZES.D },
  { tab: "products",  sec: "E", label: "④金融商品 E：REIT（Real Estate Investment Trust：不動産投資信託）",          quizzes: PRODUCTS_QUIZZES.E },
  ...
  { tab: "casestudy", sec: "CS4", label: "⑤ケース CS4：理論株価",          quizzes: CASESTUDY_QUIZZES.CS4 },
  { tab: "casestudy", sec: "CS5", label: "⑤ケース CS5：社債と発行条件",    quizzes: CASESTUDY_QUIZZES.CS5 },
  { tab: "casestudy", sec: "CS6", label: "⑤ケース CS6：ポートフォリオ効果",quizzes: CASESTUDY_QUIZZES.CS6 },
  { tab: "casestudy", sec: "CS7", label: "⑤ケース CS7：収益率評価手法",    quizzes: CASESTUDY_QUIZZES.CS7 },
  { tab: "casestudy", sec: "CS8", label: "⑤ケース CS8：分配金と元本",      quizzes: CASESTUDY_QUIZZES.CS8 },
];
